...
static MSEAGView *openGLPreviewView = nil;
static MSEAGView *openGLRemoteView = nil;
static MSEAGView *openGLLocalView = nil;
static MSEAGView *openGLBFCPView = nil;

@implementation MSEAGView


+(MSEAGView *)getRemoteVideoViewWithFrame:(CGRect)frame
{
...
+(MSEAGView *)getLocalVideoViewWithFrame:(CGRect)frame
{
