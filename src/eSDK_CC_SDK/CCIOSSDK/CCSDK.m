...
- (void)setTransportSecurityUseTLS:(BOOL)enableTLS useSRTP:(BOOL)enableSRTP
{
    ...
    [CCCallService shareInstance].isSetSecurity = YES;
...
- (NSInteger)makeCall:(NSString *)accessCode callType:(NSString *)callType callData:(NSString *)callData verifyCode:(NSString *)verifyCode
{
    if (![CCCommonUtil accessCodeIsValid:accessCode])
    {
    ...
    [[CCICSService shareInstance] makeCallConnection:accessCode callType:callType callData:callData verifyCode:verifyCode];
