 ...
 *            <br>[cn]Hosted EC&PBX解决方案下，对应的回调通知消息：LOGIN_E_EVT_UPORTAL_AUTHORIZE_RESULT
 *            <br>[en]UC3.2 solution, the corresponding callback notification message:LOGIN_E_EVT_UC32_UPORTAL_TOKEN_REFRESH
 *            <br>[cn]UC3.2 解决方案下，对应的回调通知消息：LOGIN_E_EVT_UC32_UPORTAL_TOKEN_REFRESH
 ...
 *            <br>[cn]Hosted EC&PBX解决方案下，对应的回调通知消息：LOGIN_E_EVT_REFRESH_TOKEN_RESULT
 ...
 *            <br>[cn]此接口当前仅支持On-premise VC解决方案
