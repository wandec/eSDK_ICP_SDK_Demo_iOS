...
#define TUP_CALL_VERSION                 "TUP V600R006C00B100"
...
typedef enum tagCALL_E_LOG_LEVEL
{
    ...
    CALL_E_LOG_WARNING,      /**< [en]Indicates the warning level
                                  <br>[cn]警告级别 */     
    CALL_E_LOG_INFO,         /**< [en]Indicates the log level
                                  <br>[cn]日志级别 */      
...
typedef enum tagCALL_E_CALL_EVENT
{
    ...
    CALL_E_EVT_IDO_OVER_BFCP,              /**< [en]Indicates the IDO conference control uses bfcp mode
                                                ...
                                                <br>data：  None */    
    CALL_E_EVT_DEVICE_STATUS_CHANGE,       /**< [en]Indicates earphone device status change report
                                                <br>[cn]耳机设备状态变更上报
                                                <br>param1：TUP_INT32 istatus [en]Indicates speak status, 0: end speak; 1: start speak.[cn]发言状态，取值：0:结束说话  1:开始说话
                                                <br>data：  None */    
...
typedef struct tagCALL_S_CALL_INFO
{
    ...
    TUP_UINT32                ulConfMediaType;                          /**< [en]Indicates [modify]media_type = CALL_E_CONF_MEDIA_AUDIO|CALL_E_CONF_MEDIA_VIDEO|CALL_E_CONF_MEDIA_DATA . [cn]服务器会议媒体类型，取值参考CALL_E_CONF_MEDIA_TYPE, 可进行"|"操作 */
...
typedef struct tagCALL_S_VIDEO_STREAM_INFO
{
    ...
    TUP_UINT32 ulVideoSendBitRate;                      /**< [en]Indicates encode bit rate(bps). [cn]编码码率(bps) */
...
typedef struct tagCALL_S_STREAM_INFO
{
    ...
    CALL_S_VIDEO_STREAM_INFO stSvcVideoStreamInfo[CALL_D_MAX_SVC_LABLE_NUM];    /**< [en]Indicates svc video stream information. [cn]多流视频流信息*/
...
{
    TUP_CHAR              confid[CALL_D_MAX_CONFID_LEN];             /**< [en]Indicates the conference ID. [cn]会议ID */
    TUP_CHAR              access_code[CALL_D_MAX_CONF_ACCESS_LEN];   /**< [en]Indicates a reservation conference access code. [cn]预约会议接入码 */
    TUP_CHAR              conf_paswd[CALL_D_MAX_CONF_PASWD_LEN];     /**< [en]Indicates the enrollment password. [cn]入会密码 */
} CALL_S_CONF_PARAM;
...
typedef struct tagCALL_S_CIPHERLIST
{
    ...
    CALL_E_CIPHER_TYPE *peCipherList;      /**[en]cipher list [cn]加密套内容*/
} CALL_S_CIPHERLIST;
...
#define CALL_E_CFG_CONF_ENABLE_INTERCONF           CALL_D_CFG_CONF_ENABLE_INTERCONF         /**< [en]Indicates the current version is not supported
                                                                                                 <br>[cn]当前版本不支持 */
#define CALL_E_CFG_CONF_MS_ADDR                    CALL_D_CFG_CONF_MS_ADDR                  /**< [en]Indicates test program used, MS address, string
                                                                                                 <br>[cn]测试程序使用,MS地址，字符串[MODIFY] */
#define CALL_E_CFG_CONF_APPAGENT_ADDR              CALL_E_CFG_CONF_APPAGENT_ADDR            /**< [en]Indicates test program used, APP agent address
                                                                                                 <br>[cn]测试程序使用,APP Agent地址[MODIFY] */
...
#define CALL_D_CFG_SIP_REJECT_VIDEO_TYPE           CFG_ID_DEF(CALL_E_CFG_SIP, CALL_E_CFG_DATA_TYPE_INT,             0xF, 0)  /**< [en]Indicates reject video reply signaling, the corresponding enumeration is CALL_E_REJECTCALL_TYPE, the default value is CALL_D_REJECTVIDEOTYPE_200.
                                                                                                                                  <br>[cn]拒接视频回复信令，对应枚举为CALL_E_REJECTCALL_TYPE，默认值为CALL_D_REJECTVIDEOTYPE_200。*/
...
/* SDP */
#define CALL_D_CFG_MEDIA_SRTPMKI                   CFG_ID_DEF(CALL_E_CFG_SDP, CALL_E_CFG_DATA_TYPE_BOOL,            0x1, 0)  /**< [en]Indicates whether or not to open SRK mki way, the default no
                                                                                                                                  <br>[cn]SRTP是否打开mki方式，默认否 */
...
#define CALL_D_CFG_MEDIA_MERGE_SRTP_RTP            CFG_ID_DEF(CALL_E_CFG_SDP, CALL_E_CFG_DATA_TYPE_BOOL,            0x3, 0)  /**< [en]Indicates whether or not to merge SRTP and RTP m lines, the default No
                                                                                                                                  <br>[cn]是否合并SRTP和RTP的m行，默认否 */
#define CALL_D_CFG_MEDIA_RTP_PRIORITY              CFG_ID_DEF(CALL_E_CFG_SDP, CALL_E_CFG_DATA_TYPE_INT,             0x4, 0)  /**< [en]Indicates RTP, srtp priority in the media line, corresponding to SIPC_TUP_SRTP_PRI_E enumeration, the default value is SIPC_TUP_SRTP_PRI.
                                                                                                                                  <br>[cn]媒体行中rtp、srtp优先顺序，对应枚举为SIPC_TUP_SRTP_PRI_E，默认值为SIPC_TUP_SRTP_PRI。*/ 
#define CALL_D_CFG_MEDIA_CRYPTOSUITE               CFG_ID_DEF(CALL_E_CFG_SDP, CALL_E_CFG_DATA_TYPE_STRING,          0x5, 0)  /**< [en]Indicates SRTP encryption set, string, default "1, 2", where 1: AES_CM_128_HMAC_SHA1_80 2: AES_CM_128_HMAC_SHA1_32.
                                                                                                                                  <br>[cn]SRTP加密套，字符串，默认"1,2"，其中1：AES_CM_128_HMAC_SHA1_80  2：AES_CM_128_HMAC_SHA1_32。*/ 
#define CALL_D_CFG_MEDIA_SDP_OLINE_INFO            CFG_ID_DEF(CALL_E_CFG_SDP, CALL_E_CFG_DATA_TYPE_STRUCTURE,       0x6, 0)  /**< [en]Indicates set SDP, the corresponding structure CALL_S_SDP_OLINE_INFO, the default {"huawei", "23293", "1"}
                                                                                                                                  <br>[cn]设置SDP，对应结构体CALL_S_SDP_OLINE_INFO，默认{“huawei”,"23293","1"} */
...
#define CALL_D_CFG_MEDIA_FORCE_IDR_INFO            CFG_ID_DEF(CALL_E_CFG_MEDIA, CALL_E_CFG_DATA_TYPE_BOOL,          0x6, 0)  /**< [en]Indicates global media configuration: whether to force open the send and receive info idr request, the default No
                                                                                                                                  <br>[cn]全局媒体配置:是否强制打开info idr请求的收发，默认否 */
...
#define CALL_D_CFG_MEDIA_IFRAME_METHOD             CFG_ID_DEF(CALL_E_CFG_MEDIA, CALL_E_CFG_DATA_TYPE_BOOL,          0x8, 0)  /**< [en]Indicates global Media Configuration: I Frame Control, Default No
                                                                                                                                  <br>[cn]全局媒体配置:I帧控制，默认否 */
#define CALL_D_CFG_MEDIA_FLUID_CONTROL             CFG_ID_DEF(CALL_E_CFG_MEDIA, CALL_E_CFG_DATA_TYPE_BOOL,          0x9, 0)  /**< [en]Indicates global Media Configuration: Flow Control, Default No
                                                                                                                                  <br>[cn]全局媒体配置:流控，默认否 */
...
#define CALL_D_CFG_AUDIO_FEC               CFG_ID_DEF(CALL_E_CFG_AUDIO, CALL_E_CFG_DATA_TYPE_BOOL,           0x22, 0) /**< [en]xxxx
                                                                                                                                        <br>[cn]音频配置:是否支持FEC1.0能力，0关闭 1开启，默认开启。*/
#define CALL_D_CFG_AUDIO_FEC2               CFG_ID_DEF(CALL_E_CFG_AUDIO, CALL_E_CFG_DATA_TYPE_BOOL,           0x23, 0) /**< [en]xxxx
                                                                                                                                        <br>[cn]音频配置:是否支持FEC2.0能力，0关闭 1开启，默认开启。*/
#define CALL_D_CFG_AUDIO_DTMF_SIGNAL_INPUT         CFG_ID_DEF(CALL_E_CFG_AUDIO, CALL_E_CFG_DATA_TYPE_BOOL,            0x24, 0) /**< [en]DTMF Send Mode, for cisco MCU.
                                                                                                                                        <br>[cn]与思科MCU互通新增,DTMF发送模式。*/
...
#define CALL_D_CFG_VIDEO_KEYFRAMEINTERVAL          CFG_ID_DEF(CALL_E_CFG_VIDEO, CALL_E_CFG_DATA_TYPE_INT,           0xB, 0)  /**< [en]Indicates video configuration: keyframe interval value [0,30] in s, default 10.
                                                                                                                                  <br>[cn]视频配置:关键帧间隔 取值[0,30] 单位为s，默认10。*/
...
#define CALL_D_CFG_DATA_KEYFRAMEINTERVAL           CFG_ID_DEF(CALL_E_CFG_AUX, CALL_E_CFG_DATA_TYPE_INT,             0xA, 0)  /**< [en]Indicates data configuration: key frame interval value [0,30] in units of s, the default 10.
                                                                                                                                  <br>[cn]数据配置:关键帧间隔 取值[0,30] 单位为s，默认10。*/
