 ...
 **/
TUP_API TUP_RESULT tup_offlinefile_createfolder(IN const TUP_CHAR* group_space_id, IN const OFFLINE_FOLDERSET* folder_set, OUT OFFLINE_FOLDERINFO* folder_info);
 ...
 **/
TUP_API TUP_RESULT tup_offlinefile_deletefolder(IN OFFLINE_DELETEFOLDER* delete_folder);
 ...
 * @see tup_offlinefile_createfolder
 **/
TUP_API TUP_RESULT tup_offlinefile_modifyfolder(IN TUP_CHAR* group_space_id, IN TUP_LONG folder_id, IN TUP_CHAR* folder_name, OUT OFFLINE_FOLDERINFO* folder_info);
 ...
 **/
TUP_API TUP_RESULT tup_offlinefile_movefolder(IN TUP_CHAR* group_space_id, IN TUP_LONG folder_id, IN TUP_LONG dest_parentid, OUT OFFLINE_FOLDERINFO* folder_info);
 ...
 **/
TUP_API TUP_RESULT tup_offlinefile_copyfolder(IN TUP_CHAR* group_space_id, IN TUP_LONG folder_id, IN TUP_LONG dest_parentid, OUT OFFLINE_FOLDERINFO* folder_info);
 ...
 **/
TUP_API TUP_RESULT tup_offlinefile_movefile(IN TUP_CHAR* group_space_id, IN TUP_LONG file_id, IN TUP_LONG dest_parentid, OUT OFFLINE_FILEINFO* file_info);
 ...
 **/
TUP_API TUP_RESULT tup_offlinefile_copyfile(IN TUP_CHAR* group_space_id, IN TUP_LONG file_id, IN TUP_LONG dest_parentid, IN TUP_BOOL from_group, OUT OFFLINE_FILEINFO* file_info);
 ...
 * @see tup_offlinefile_uploadfile
 **/
TUP_API TUP_RESULT tup_offlinefile_getgroupfiledownloadurl(IN TUP_CHAR* group_space_id, IN TUP_LONG file_id, OUT TUP_CHAR** download_url);
 ...
 **/
TUP_API TUP_RESULT tup_offlinefile_listsubdirectory(IN const OFFLINE_LISTSUBSET* list_subset, OUT OFFLINE_DIRECTORY** directory_info);
 ...
 *            <br>[cn]如果接口返回成功，用户使用完*directory_info以后，需要调用tup_offlinefile_releasedirectory释放*directory_info指向的内存。
 **/
TUP_API TUP_RESULT tup_offlinefile_searchbyname(IN const OFFLINE_SEARCHINFO* search_info, OUT OFFLINE_DIRECTORY** directory_info);
 ...
 **/
TUP_API TUP_RESULT tup_offlinefile_listfileversion(IN const OFFLINE_SEARCHFILEVERSION* search_version, OUT OFFLINE_FILEVERSION** file_versions);
