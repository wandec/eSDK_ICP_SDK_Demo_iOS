 ...
 *        <br>[cn]注册辅流业务截屏函数
 * 
 * @param [in] CALL_FN_CAPTURE_SCREEN_PTR capture_screen_func <b>:</b><br>[en] xxxx
 *                                                                    <br>[cn] 辅流截屏函数地址
 * @retval TUP_RESULT <b>:</b><br>[en] If it's success return TUP_SUCCESS, otherwise return the corresponding error code.
 *                            <br>[cn] 成功返回TUP_SUCCESS，失败返回相应错误码
 * 
 ...
 *        <br>[cn] SIP账号注册
 * 
 * @param [in] const TUP_CHAR* number     <b>:</b><br>[en] Indicates user number,Maximum length of 32 characters
 *                                                <br>[cn] 用户号码，最大长度32
 * @param [in] const TUP_CHAR* name       <b>:</b><br>[en] Indicates user name,Maximum length of 255 characters
 *                                                <br>[cn] 用户名，最大长度255
 ...
 *                                                     <br>[cn] 呼叫类型
 * @param [in] const TUP_CHAR* callee_number   <b>:</b><br>[en] Indicates called number, maximum length of 256 characters
 *                                                     <br>[cn] 被叫号码，最大长度256
 * @retval TUP_RESULT                          <b>:</b><br>[en] If it's success return TUP_SUCCESS, otherwise return the corresponding error code.
 *                                                     <br>[cn] 成功返回TUP_SUCCESS，失败返回相应错误码
 * 
 ...
 *                                        <br>[cn] 成功返回TUP_SUCCESS，失败返回相应错误码
 * 
 * @attention [en]Calling this interface requires a first call to tup_call_serverconf_create to complete the session creation 
