...
typedef enum tagCONFCTRL_E_EVENT
{
    ...
    CONFCTRL_E_EVT_ENTER_PASSWORD_TO_BE_CHAIRMAN,   /**< [en]Indicates enter the chairman password instructions, currently only TE20 use, to be called after the user interface tup_confctrl_enter_chairman_password
                                                         <br>[cn]输入主席密码指示，目前仅TE20使用，待用户输入后调用接口tup_confctrl_enter_chairman_password
                                                         <br>param1：TUP_UINT32 handle [en]Indicates conference control handle.[cn]会控句柄
                                                         <br>param2：None   
                                                         <br>data：  None */
    ...
    CONFCTRL_E_EVT_ATTENDEE_BROADCASTED_IND,        /**< [en]Indicates participants are currently viewing (Venue) instructions, names obtained unreasonable
                                                         <br>[cn]当前正在观看的与会者（会场）指示，名字取得不合理
                                                         <br>param1：TUP_UINT32 handle [en]Indicates conference control handle.[cn]会控句柄
                                                         <br>param2：None   
    ...
    CONFCTRL_E_EVT_FLOOR_ATTENDEE_IND,              /**< [en]Indicates notice of the speaker
                                                         ...
                                                         <br>data：  TE_FLOOR_ATTENDEE* floor_attendee[en]Indicates speaker info in On-premise VC conference and Hosted VC conference.[cn]On-premise VC会议和Hosted VC会议下的发言方信息
                                                                     CONFCTRL_S_FLOOR_ATTENDEE_INFO* floor_attendee[en]Indicates speaker info in convergent meeting(include PBX internal meeting).[cn]Convergent meeting 融合会议(包括PBX内置会议)下的发言方信息 */
    ...
    CONFCTRL_E_EVT_GET_CONF_LIST_RESULT,             /**< [en]Indicates get conference list result
                                                          <br>[cn]获取会议列表结果
                                                          <br>param1：TUP_UINT32 handle [en]Indicates conference control handle.[cn]会控句柄
                                                          <br>param2：TUP_UINT32 conf_count [en]Indicates conference count.[cn]会议个数
    ...
    CONFCTRL_E_EVT_GET_VMR_LIST_RESULT,              /**< [en]Indicates to get VMR result
                                                          ...
                                                          <br>param1：TUP_UINT32 result [en]Indicates operation result.[cn]操作结果
                                                          <br>param2：None
                                                          <br>data：  CONFCTRL_S_VMR_LIST* vrm_list [en]Indicates VMR list.[cn]VMR列表 */
    ...
    CONFCTRL_E_EVT_SVC_WATCH_RESULT,                /**< [en]Indicates svc watch result
                                                         <br>[cn]SVC视频观看结果
                                                         <br>param1：TUP_UINT32 handle  [en]handle of conference [cn]会控句柄
                                                         <br>param2：TUP_UINT32 result  [en]operate result [cn]操作结果
                                                         <br>data： None */
                                                         
    CONFCTRL_E_EVT_SVC_WATCH_IND,                   /**< [en]Indicates svc video watch indicate
                                                         <br>[cn]SVC视频观看指示
                                                         <br>param1：TUP_UINT32 handle  [en]handle of conference [cn]会控句柄
                                                         <br>param2：TUP_UINT32 conf_count [en]number of conference [cn]会议个数
                                                         <br>data：CONFCTRL_S_SVC_REPORT* svc_report [en]Indicates svc report info.[cn]会议与svc列表信息 */
    CONFCTRL_E_EVT_BUTT
} CONFCTRL_E_EVENT;
...
typedef enum tagCC_SITECALL_REASON_E
{
    ...
    SITECALL_GK_AUTHOR_FAILED                /**< [en]Indicates GK author failed
                                                  <br>[cn] gk密码认证失败 */
} CC_SITECALL_REASON_E;                      //原定义在prot_callctrl_public.h中
...
{
    TUP_UINT8                nTerminalIDLength;     /**< [en]Indicates terminal byname length. [cn]别名长度：1-128 */
    ...
    TUP_UINT32               udwSiteBandwidth;      /**< [en]Indicates conference hall bandwidth. [cn]会场带宽，单位:kbps */
...
} CC_SITECALL_PAYMODE; //原H323C_SITECALL_PAYMODE
...
{
    TUP_UINT8                   ucSiteCallType;        /**< [en]Indicates call set type, at present only support one kind, keep default value CONFCTRLC_E_CALLTYPE_SIP, value refer to  CONFCTRLC_E_CALL_TYPE, required. [cn]主叫呼集类型，当前仅支持一种，保持默认值CONFCTRLC_E_CALLTYPE_SIP，取值参考CONFCTRLC_E_CALL_TYPE，必选 */
    TUP_UINT16                  ulSiteNumber;          /**< [en]Indicates site number,required. [cn]会场数目，必选 */
    CC_AddTerminalInfo *        pcParam1;              /**< [en]Indicates chairman add conference hall struct param, required. [cn]主席添加会场的结构参数，必选 */
    TUP_UINT32                  TerminalDataRate;      /**< [en]Indicates QB_V2 is bandwidth value, bandwidth unit is 100 bit/s optional. [cn]QB_V2为带宽值，注意：带宽单位为100bit/s，可选 */
    TUP_UINT16                  usPwdLen;              /**< [en]Indicates conference password length optional. [cn]会议密码长度，可选 */
    TUP_UINT8 *                 pucPwd;                /**< [en]Indicates conference password pointer optional. [cn]会议密码指针。可选 */
    TUP_UINT16                  usAnonymousSiteNumber; /**< [en]Indicates anonymous site number optional. [cn]匿名会场个数，可选 */
    TUP_UINT8                   ucHasMuiltiPic;        /**< [en]Indicates whether has multi-picture optional. [cn]是否有多画面,取值:1为有，0为无，可选 */
    TUP_UINT32                  ulSubPicCnt;           /**< [en]Indicates sub picture count optional. [cn]总的子画面个数,多组多画面新增。可选 */
    TUP_UINT32                  ulMultiPicGroupCnt;    /**< [en]Indicates multi-picture group count optional. [cn]多画面组数,多组多画面新增，可选 */
    TUP_UINT16                  usConfNameLen;         /**< [en]Indicates conference name length optional. [cn]会议名称长度，可选 */
    TUP_UINT8 *                 pucConfName;           /**< [en]Indicates conference name pointer optional. [cn]会议名称指针，可选 */
    TUP_UINT8 *                 pucLanguage;           /**< [en]Indicates terminal language info, set language-country for example "zh-CN","en-US","zh-TW" optional. [cn]终端语种信息，设置语言-国家代码，如："zh-CN","en-US","zh-TW"等，可选 */
    CC_SITECALL_PAYMODE *       pPayMode;              /**< [en]Indicates pay mode structure pointer optional. [cn]付费方式结构体指针，可选 */
    TUP_UINT8                   ucHasDataConf;         /**< [en]Indicates Whether include data conference, value: 2 means include, 0 means no, optional. [cn]是否包含数据会议，取值:2为包含数据会议，0为不包含，可选 */
    TUP_UINT8                   ucHasAuxVideo;         /**< [en]Indicates whether has aux video,value: 1 means include, 0 means no, optional. [cn]是否包含双流，取值:1为包含双流，0为不包含，可选 */
    TUP_UINT8                   ucbMVRecord;           /**< [en]Indicates whether support record_flag,value: 1 means include, 0 means no, optional. [cn]是否支持录，取值:1为支持，0为不支持，可选 */
    TUP_UINT8                   ucbMVBroadcast;        /**< [en]Indicates whether support broadcast,value: 1 means include, 0 means no, optional. [cn]是否支持直接播，取值:1为支持，0为不支持，可选 */
    TUP_UINT8                   ucRoleLabel;           /**< [en]Indicates role label optional. [cn]角色标签，可选 */
    CC_IP_ADDR_S                stLocalAddr;           /**< [en]Indicates local address, static ip need to be set under ios, otherwise http can't connect server optional. [cn]本地地址，iOS下如果为静态ip需要设置，否则http组件无法联通服务器，可选 */
    CC_IP_ADDR_S                stServerAddr;          /**< [en]Indicates server address, if it's 4E1,address type is mcu, otherwise it's invalid, currently writer sc address optional. [cn]服务端地址，如果是4E1,则为mcu地址，否则无效 zhubin：当前填SC地址，可选 */  
    TUP_UINT8                   ucSiteCallMode;        /**< [en]Indicates site call mode, 0 means convene immediately, 1 means reserve convene value: 1 means booking meeting, 0 means immediately convene, optional. [cn]主叫呼即方式，取值:0：立即召开，1：预约召开。可选 */
    TUP_UINT32                  ulSiteCallStartTime;   /**< [en]Indicates if reserve convene, it's start time, otherwise it's invalid optional. [cn]如果是预约召开，则为开始时间，否则无效，可选 */
    TUP_UINT32                  ulSiteCallTime;        /**< [en]Indicates if reserve convene, it's last time. [cn]如果是预约召开，则为持续时间（UTC），可选 */
    TUP_INT32                   lTimezoneOffset;       /**< [en]Indicates current time zone off set optional. [cn]当前时区偏移，可选 */
    CC_VIDEO_PROTOCOL_E         eVideoProto;           /**< [en]Indicates video protocol, auto adapt is CC_VIDEO_PROTO_BUTT optional. [cn]视频协议,自适应填CC_VIDEO_PROTO_BUTT，可选 */
    CC_VIDEO_FORMAT_E           eVideoFormat;          /**< [en]Indicates video format. [cn]视频分辨率格式，可选 */
    CC_VIDEO_FRAMERATE_E        eVideoFrameRate;       /**< [en]Indicates video frame rate. At present, H264 video format 720P 50/60 1080P 50/60 write 0x05, other situation can default write 0x01, refer to CC_VIDEO_FRAMERATE_E optional. [cn]视频帧率(目前，除H264视频格式720P 50/60 1080P 50/60 时填0x05，其它情况可缺省填0x01，见CC_VIDEO_FRAMERATE_E定义)，可选 */
    CC_AUDIO_PROTOCOL_E         eAudioProto;           /**< [en]Indicates audio protocol, auto adapt is CC_AUDIO_PROTOCOL_BUTT optional. [cn]音频协议，自适应填CC_AUDIO_PROTOCOL_BUTT，可选 */
    CC_H235_POLICY_E            eH235Policy;           /**< [en]Indicates H234 policy optional. [cn]H235策略使用，可选 */
    CC_SRTP_POLICY_E            eSipSrtpPolicy;        /**< [en]Indicates sip srtp policy optional. [cn]SIP主叫呼集加密策略，可选 */
    CC_SITE_CALL_MODE_E         eSiteCallMode;         /**< [en]Indicates site call mode(normal mode, report mode) optional. [cn]会议模式(普通模式、汇报模式)，可选 */
    CONFCTRLC_S_VOICECTRL_PARAM stVoiceCtrlParam;      /**< [en]Indicates voice control param optional. [cn]声控切换参数信息，可选 */
    TUP_UINT8*                  pucScDomain;           /**< [en]Indicates registerd sc server. optional. [cn]SIP账号注册的SC地址，用于在多SC组网下指定主叫呼集业务服务器，可选*/
...
{
    TUP_UINT8            ucSiteCallType;       /**< [en]Indicates site call type, support only one at present, keep default, application layer do not need. [cn]主叫呼集类型，当前仅支持一种，保持默认值，应用层暂无需填写 */
    TUP_UINT8            ucConferenceType;     /**< [en]Indicates conference type. [cn]会议类型，取值参考CONFCTRL_E_CONF_ENV_TYPE */
...
typedef struct tagCONFCTRL_SITECALLCONFLISTQUERY_INFO_S
{
    ...
    TUP_UINT8 *         pucLanguage;          /**< [en]Indicates terminal language information. [cn]终端语种信息 */
    //TUP_UINT8            ucGetConfListType;       /**< [en]xxxx. [cn]终端语种信息 */
...
typedef enum tagCONFCTRL_E_CONF_ENV_TYPE
{
    ...
    CONFCTRL_E_CONF_ENV_CONVERGENT_MEEYING,    /**< [en]Indicates Convergent meeting: EC solutions, IMS Hosted&SP Hosted network, and all network of internal conference in PBX solutions [cn]Convergent meeting 融合会议: EC解决方案, IMS Hosted&SP Hosted组网；以及PBX解决方案下的内置会议所有组网 */
...
typedef struct tagCONFCTRL_S_CIPHERLIST
{
    ...
    TUP_UINT32 uiSize;                           /**[en]Indicates number of ciphers in array [cn]数组实际加密套个数*/
    CONFCTRL_E_CIPHER_TYPE *peCipherList;        /**[en]Indicates cipher list [cn]加密套内容*/
...
typedef struct tagTE_ATTENDEE_DATA_IN_LIST
{
    ...
    TUP_UINT8  ucType;                                       /**< [en]Indicates UC type, value refer to h323mmGBSiteCallTerminalType. [cn]会场线路类型，取值参考h323mmGBSiteCallTerminalType */
...
{
    TUP_UINT8          ucCnt;                 /**< [en]Indicates uc count. [cn]发言方数量 */
...
typedef struct tagTE_CONF_CTRL_INFO
{
    ...
    TUP_UINT8            ucConfState;                                           /**< [en]Indicates conference state. [cn]会控状态(CONF_STATE)，取值参考CONFCTRL_E_CONF_STATE */
    ...
    TUP_UINT8            ucVoiceSwitch;                                         /**< [en]Indicates voice control switch set at local. [cn]本地设置的声控开关状态，取值:0 关 1开 */
    ...
    TUP_UINT8            ucIsReportMode;                                        /**< [en]Indicates whether is report mode. [cn]是否汇报模式,取值:1为是，0为否 */
    ...
    //UI_S_MULTIPIC_GROUP_INFO stViewedMultiGrpPic;                               /* 被观看的多组多画面信息                           */
    //UI_S_MULTIPIC_GROUP_INFO astMultiPicGrpInfo[UI_MAX_MULPIC_GROUP_SUM];       /* 多组多画面                                       */
    ...
    //UI_MULTI_PIC_GROUP_OPER_RSP_INFO astMultiPicGrpOperRspInfo;                 /* 最近一次的多组多画面操作响应         */

    //UI_S_TP_MULTIPIC_IND astViewInfo[UI_MAX_TPSCREEN_NUM];                      /* 本端左，中，右屏观看源信息           */
...
{
    TUP_UINT32  ulOperateType;        /**< [en]Indicates operate type, 0:lock, 1:unlock. [cn]操作类型,取值:0锁定,1解锁*/
...
typedef struct tagCONFCTRL_S_DATACONF_PARAMS
{
    ...
    TUP_INT8    site_url[CONFCTRL_D_MAX_URL_LEN];          /**< [en]Indicates site url. [cn]会议网站地址*/
    TUP_INT8    site_id[CONFCTRL_D_MAX_CONF_ID_LEN];       /**< [en]Indicates site id. [cn]站点ID空*/
    ...
    TUP_UINT32  M;                                         /**< [en]participant M number. [cn]M 号 */
    TUP_UINT32  T;                                         /**< [en]participant T number. [cn]T 号 */
...
{
    TUP_CHAR  subject[CONFCTRL_D_MAX_SUBJECT_LEN];         /**< [en]Indicates optional, conference subject. [cn]可选，会议主题 */
    TUP_CHAR  group_uri[CONFCTRL_D_MAX_GROUP_URI_LEN];     /**< [en]Indicates group uri. [cn]可选，群组uri */

    CONFCTRL_E_CONF_WARNING_TONE  welcome_voice_enable;    /**< [en]Indicates optional, switch of welcome voice. [cn]可选，入会欢迎词开关 */
    CONFCTRL_E_CONF_WARNING_TONE  enter_prompt;            /**< [en]Indicates optional, participant enter prompt switch. [cn]可选，有成员入会提示音开关 */
    CONFCTRL_E_CONF_WARNING_TONE  leave_prompt;            /**< [en]Indicates optional, participant leave prompt switch. [cn]可选，有成员离会提示音开关 */
    TUP_BOOL  conf_filter;             /**< [en]Indicates optional, whether conference start filter. [cn]可选，会议是否过滤，预留 */
    TUP_BOOL  record_flag;             /**< [en]Indicates optional, whether conference start record. [cn]可选，会议是否自动启动录制，预留 */
    TUP_BOOL  multi_stream_flag;       /**< [en]Indicates optional, whether conference is multi-stream flag. [cn]可选，是否为多流视频会议 */
    
    TUP_UINT32 media_type;                      /**< [en]Indicates media type, value refer to CONFCTRL_E_CONF_MEDIATYPE_FLAG, can do "|" operate. [cn]媒体类型，取值参考CONFCTRL_E_CONF_MEDIATYPE_FLAG，可进行"|"操作 */
    CONFCTRL_E_LANGUAGE language;               /**< [en]Indicates optional, default language of conference. [cn]可选，会议的默认语言 */
    CONFCTRL_E_ENCRYPT_MODE conf_encrypt_mode;  /**< [en]Indicate optional,s conference media encrypt mode. [cn]可选，会议媒体加密模式  */
    CONFCTRL_E_USER_TYPE user_type;             /**< [en]Indicates optional, user type of conference created user. [cn]可选，创会用户的用户类型 */

    TUP_UINT32 num_of_attendee;                         /**< [en]Indicates attendee number. [cn]与会者个数 */
    CONFCTRL_S_ATTENDEE* attendee;                      /**< [en]Indicates attendee info. [cn]与会者信息 */
    CONFCTRL_S_ASSISTANT_MEDIA* assistant_media_params; /**< [en]Indicates optional, aux data param, this param valid to video conf. [cn]可选，辅流参数，该参数对视频会议有效 */
...
typedef struct tagCONFCTRL_S_BOOK_CONF_INFO_UPORTAL
{
    ...
    TUP_CHAR start_time[CONFCTRL_D_MAX_TIME_FORMATE_LEN];  /**< [en]Indicates optional, conference start time, format:YYYY-MM-DD HH:MM. [cn]可选，会议开始时间，格式：YYYY-MM-DD HH:MM，如果没有指定开始时间，则表示会议马上开始 */
    TUP_UINT32 conf_len;                                   /**< [en]Indicates conference length of time, unit is minute. [cn]会议持续时长，单位分钟 */
    TUP_CHAR subject[CONFCTRL_D_MAX_SUBJECT_LEN];          /**< [en]Indicates optional, conference subject. [cn]可选，会议主题 */
    ...
    TUP_BOOL  conf_filter;               /**< [en]Indicates optional, whether conference start filter. [cn]可选，会议是否过滤，预留 */
    TUP_BOOL  record_flag;               /**< [en]Indicates optional, whether conference start record. [cn]可选，会议是否自动启动录制，预留 */
    TUP_BOOL  auto_prolong;              /**< [en]Indicates optional, whether auto prolong conference. [cn]可选，是否自动延长会议 */
    TUP_BOOL  multi_stream_flag;         /**< [en]Indicates optional, whether is multi-stream video conference. [cn]可选，是否为多流视频会议 */
    
    CONFCTRL_E_REMINDER_TYPE reminder;            /**< [en]Indicates optional, conference remainder. [cn]可选，会议提醒方式  */
    CONFCTRL_E_LANGUAGE language;                 /**< [en]Indicates optional, conference default language. [cn]可选，会议的默认语言 */
    CONFCTRL_E_ENCRYPT_MODE conf_encrypt_mode;    /**< [en]Indicates optional, conference media encrypt mode. [cn]可选，会议媒体加密模式  */
    CONFCTRL_E_USER_TYPE user_type;               /**< [en]Indicates optional, conference creator user type. [cn]可选，预定者的用户类型 */

    TUP_UINT32 num_of_attendee;          /**< [en]Indicates optional, attendee number. [cn]可选，与会者个数 */
    CONFCTRL_S_ATTENDEE* attendee;       /**< [en]Indicates optional, attendee info. [cn]可选，与会者信息 */

    CONFCTRL_S_CYCLE_PARAM* cycle_params;               /**< [en]Indicates required, cycle conference param, preserve. [cn]条件必选，周期会议的参数，预留 */
    CONFCTRL_S_ASSISTANT_MEDIA* assistant_media_params; /**< [en]Indicates optional, aux data param, this param is valid to video conf. [cn]可选，辅流参数，该参数对视频会议有效 */
...
typedef struct tagCONFCTRL_S_BOOK_CONF_INFO_MEDIAX
{
    ...
    TUP_ULONG start_time;                          /**< [en]Indicates optional, conference start time, format:YYYY-MM-DD HH:MM. [cn]可选，会议开始时间 格式：YYYY-MM-DD HH:MM */
    TUP_ULONG summer_time;                         /**< [en]Indicates optional, conference summer time, format:YYYY-MM-DD HH:MM. [cn]可选，会议结束时间 格式：YYYY-MM-DD HH:MM 默认为startTime后一个小时 */
    TUP_ULONG conf_len;                            /**< [en]Indicates required, conference length of time, unit is minute.. [cn]必选，会议时长 */
    TUP_CHAR subject[CONFCTRL_D_MAX_SUBJECT_LEN];  /**< [en]Indicates optional, conference subject. [cn]可选，会议主题 */
    ...
    CONFCTRL_S_ASSISTANT_MEDIA* assistant_media_params; /**< [en]Indicates aux data param, this param is valid to video conf. [cn]可选，辅流参数，该参数对视频会议有效 */
...
{
    CONFCTRL_E_CONF_ROLE conf_role;                      /**< [en]Indicates conference role. [cn]会议角色  */
    TUP_CHAR conf_id[CONFCTRL_D_MAX_CONF_ID_LEN];        /**< [en]Indicates conference id. [cn]会议id */
    TUP_CHAR password[CONFCTRL_D_MAX_PASSWORD_LEN];      /**< [en]Indicates conference password. [cn]会议密码 */
    TUP_UINT32 media_type;                               /**< [en]Indicates media type, value refer to CONFCTRL_E_CONF_MEDIATYPE_FLAG, can do "|" operate. [cn]媒体类型，取值参考CONFCTRL_E_CONF_MEDIATYPE_FLAG，可进行"|"操作 */
...
typedef struct tagCONFCTRL_S_GET_CONF_INFO
{
    ...
    TUP_UINT32 page_size;                         /**< [en]Indicates return attendee record info. [cn]返回与会者的记录数 */
...
{
    TUP_CHAR name[CONFCTRL_D_MAX_NAME_LEN];                /**< [en]Indicates VMR name. [cn]VMR名字 */
    TUP_CHAR access_number[CONFCTRL_D_MAX_ACCESS_NUM_LEN]; /**< [en]Indicates access number. [cn]VMR接入号 */
    TUP_CHAR conf_id[CONFCTRL_D_MAX_CONF_ID_LEN];          /**< [en]Indicates VMR conference id. [cn]VMR会议ID */
    ...
    TUP_BOOL without_host_enable;                            /**< [en]Indicates whether enable guest join conference before without host. [cn]主席入会前是否允许来宾入会开始会议 */
} CONFCTRL_S_VMR_INFO;
