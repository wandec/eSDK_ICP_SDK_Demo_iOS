...
enum{
    ...
    TC_AUDIO_ERROR_PHONE_MGW_NOT_RESPONSE          = 1430,   /**< [en]Indicates gateway did not respond 
                                                                  <br>[cn]网关未反应 */     
    TC_AUDIO_ERROR_TRY_LATER                       = 1431,   /**< [en]Indicates to try again later [modify]
                                                                  <br>[cn]正在打开[TODO]稍后重试(文档中文正在打开，个人理解应该为稍后重试)*/     
...
enum
{
    ...
    CONF_MSG_ON_CONFERENCE_JOIN         = 1001,        /**< [en]Indicates the notice of join a conference 
                                                            <br>[cn]加入会议通知
                                                            <br>param1: [en]Indicates the TcResult result. [cn]TcResult结果 
                                                            <br>param2: [en]NA. [cn]NA
                                                            <br>data: [en]NA. [cn]NA */ 
    CONF_MSG_ON_CONFERENCE_TERMINATE    = 1002,        /**< [en]Indicates the notice of end of conference  
                                                            <br>[cn]会议结束通知  
                                                            <br>param1: [en]Indicates the result of the TcResult operation. [cn]TcResult 操作的结果
                                                            <br>param2: [en]NA. [cn]NA.
                                                            <br>data: [en]NA. [cn]NA. */
    CONF_MSG_ON_CONFERENCE_LEAVE        = 1003,        /**< [en]Indicates the notice of leave a  conference 
                                                            <br>[cn]会议离开通知  
                                                            <br>param1: [en]Indicates TC_IMCC_REASON_USER_EJECTED. [cn]TC_IMCC_REASON_USER_EJECTED.
                                                            <br>param2: [en]Invalid indication. [cn]无效.
                                                            <br>data: [en]NA. [cn]NA. */
    CONF_MSG_ON_COM_STATUS_UPDATE       = 1004,        /**< [en]Indicates the notification component switching 
                                                            <br>[cn]组件激活或关闭通知  
                                                            <br>param1: [en]Indicates the component ID. [cn]组件ID.
                                                            <br>param2: [en]Indicates the current status (on, off). [cn]当前状态（开、关）.
                                                            <br>data: [en]NA. [cn]NA. */
    CONF_MSG_ON_PRIVILEGE_UPDATE        = 1005,        /**< [en]Indicates the notice of permission change  
                                                            <br>[cn]权限变更通知  
                                                            <br>param1: [en]Indicates the permission value. [cn]权限值.
                                                            <br>param2: [en]Indicates whether the global permission flag is set. True: set permissions for all; false: set permissions for individual users.. [cn]是否设置全局权限标志。true:设置所有人的权限；false:设置单个人的权限.
                                                            <br>data: [en]NA. [cn]NA. */
    CONF_MSG_ON_CONF_MODEL_UPDATE       = 1006,        /**< [en]The notice of conference model update 
                                                            <br>[cn]会议模式变更通知  
                                                            <br>param1: [en]Indicates the conference mode information. [cn]会议模式信息.
                                                            <br>param2: [en]Invalid indication. [cn]无效.
                                                            <br>data: [en]NA. [cn]NA. */
    CONF_MSG_ON_LAYOUT_UPDATE           = 1007,        /**< [en]Indicates the notice of conference layout change 
                                                            <br>[cn]会议布局变更通知  
                                                            <br>param1: [en]Indicates the conference layout value. [cn]会议布局值.
                                                            <br>param2: [en]Invalid indication. [cn]无效.
                                                            <br>data: [en]NA. [cn]NA. */
    CONF_MSG_ON_MESSAGE_UPADATE         = 1008,        /**< [en]Indicates conference parameter change 
                                                            <br>[cn]会议全局参数对象  
                                                            <br>param1: [en]NA. [cn]NA.
                                                            <br>param2: [en]NA. [cn]NA.
                                                            <br>data: [en]Indicates the updated param information for TC_CONF_Param_Update. [cn]TC_CONF_Param_Update 更新的param信息. */
    CONF_MSG_ON_COM_FULL_SCREEN         = 1009,        /**< [en]Indicates full screen switching 
                                                            <br>[cn]全屏切换  
                                                            <br>param1: [en]0. [cn]0.
                                                            <br>param2: [en]0. [cn]0.
                                                            <br>data: [en]NULL. [cn]NULL. */

    CONF_MSG_ON_FLOW_CONTROL            = 1010,        /**< [en]Indicates conference flow control notification 
                                                            <br>[cn]会议流控通知  
                                                            <br>param1: [en]NA. [cn]NA.
                                                            <br>param2: [en]NA. [cn]NA.
                                                            <br>data: [en]Indicates flow control informations. [cn]流控信息. */
    CONF_MSG_ON_LOCK_RSP                = 1011,        /**< [en]Indicates request a conference lock notification  
                                                            <br>[cn]请求会议锁定结果通知  
                                                            <br>param1: [en]Indicates that bLock 1 is locked and 0 is unlocked. [cn]bLock 1锁定，0解锁.
                                                            <br>param2: [en]Indicates the result of the request, TC_OK is successful. [cn]请求结果，TC_OK成功.
                                                            <br>data: [en]NA. [cn]NA. */
    ...
    CONF_MSG_ON_EXTEND_RSP              = 1014,        /**< [en]Indicates conference delay request result notification 
                                                            <br>[cn]会议延时请求结果通知  
                                                            <br>param1: [en]Indicates the time of the extension.Unit: Seconds [cn]延长的时间 单位：秒.
                                                            <br>param2: [en]Indicates the result of the request, TC_OK is successful. [cn]请求结果，TC_OK成功.
                                                            <br>data: [en]NA. [cn]NA. */
    ...
    CONF_MSG_ON_TIME_REMAINING_IND      = 1016,        /**< [en]Indicates conference end time notification 
                                                            <br>[cn]会议结束时间通知  
                                                            <br>param1: [en]Indicates the end time. [cn]结束的时间.
                                                            <br>param2: [en]NA. [cn]0.
                                                            <br>data: [en]NA. [cn]NULL. */
    ...
    CONF_MSG_ON_TABLE_INSERT_IND        = 1018,        /**< [en]Indicates notification of creating a table of meeting data type 
                                                            ...
                                                            <br>param1: [en]NA. [cn]NA.
                                                            <br>param2: [en]NA. [cn]NA.
                                                            <br>data: [en]Indicates TC_IMCC_Table_Insert. [cn]TC_IMCC_Table_Insert. */
    CONF_MSG_ON_TABLE_DELETE_IND        = 1019,        /**< [en]Indicates notification of deleting the data of a meeting
                                                            <br>[cn]会议数据类型表删除通知  
                                                            <br>param1: [en]NA. [cn]NA.
                                                            <br>param2: [en]NA. [cn]NA.
                                                            <br>data: [en]Indicates the table name. [cn]表名称. */
    CONF_MSG_ON_PING_COMPLETE           = 1020,        /**< [en]Indicates conference ping result notification
                                                            <br>[cn]会议ping结果通知  
                                                            <br>param1: [en]NA. [cn]NA.
                                                            <br>param2: [en]NA. [cn]NA.
                                                            <br>data: [en]Indicates the result information of TC_CONF_Ping_Complete. [cn]TC_CONF_Ping_Complete 结果信息. */
    CONF_MSG_ON_PING_PROGRESS_REPORT    = 1021,        /**< [en]Indicates notification of meeting ping progress 
                                                            <br>[cn]会议ping进度通知  
                                                            <br>param1: [en]NA. [cn]NA.
                                                            <br>param2: [en]NA. [cn]NA.
                                                            <br>data: [en]Indicates a progress report for Ping_Progress_Report. [cn]Ping_Progress_Report 进度汇报. */
    ...
    CONF_MSG_ON_COMPONENT_LOAD          = 1031,        /**< [en]Indicates notification that the audio component is available.  
                                                            ...
                                                            <br>param1: [en]Indicates TC_OK: Component is ready, TC_FAILURE: Component initialization failed.. [cn]TC_OK ：组件准备好,TC_FAILURE ：组件初始化失败. 
                                                            <br>param2: [en]Indicates the IID_COMPONENT_AUDIO. Component id. [cn]IID_COMPONENT_AUDIO.组件id
                                                            <br>data: [en]NULL. [cn]NULL. */
    CONF_MSG_ON_NOTICE_IND              = 1032,        /**< [en]Notification of meeting bulletin information 
                                                            <br>[cn]会议公告数据通知  
                                                            <br>param1: [en]NA. [cn]NA.
                                                            <br>param2: [en]NA. [cn]NA.
                                                            <br>data: [en]Indicates the TC_CONF_Notice_Item bulletin information. [cn]TC_CONF_Notice_Item 公告信息. */
    CONF_MSG_ON_MAX_VOICE               = 1033,        /**< [en]Indicates notification of voice motivation 
                                                            <br>[cn]语音激励消息  
                                                            <br>param1: [en]NA. [cn]NA.
                                                            <br>param2: [en]NA. [cn]NA.
                                                            <br>data: [en]Indicates the first address of the SpeakingUser array. [cn]SpeakingUser数组的首地址. */
    CONF_MSG_SERVER_TIME                = 1034,        /**< [en]Indicates notification of server time request 
                                                            <br>[cn]请求服务器时间  
                                                            <br>param1: [en]NA. [cn]NA.
                                                            <br>param2: [en]NA. [cn]NA.
                                                            <br>data: [en]Indicates the Tm server standard time. [cn]Tm 服务器标准时间. */

    CONF_MSG_ON_MUTE                    = 1041,        /**< [en]Indicates mute 
                                                            <br>[cn]静音  
                                                            <br>param1: [en]Indicates whether the sound is muted. [cn]是否静音.
                                                            <br>param2: [en]NA. [cn]NA.
                                                            <br>data: [en]NA. [cn]NA. */ 
    CONF_MSG_ON_NETSTATUS_REPORT        = 1051,        /**< [en]Indicates net status report 
                                                            <br>[cn]网络状态报告，五种状态  
                                                            <br>param1: [en]Indicates five network states. [cn]五种网络状态 .
                                                            <br>param2: [en]NULL. [cn]0.
                                                            <br>data: [en]NULL. [cn]NULL. */ 
    ...
    CONF_MSG_ON_AUTH                    = 1061,        /**< [en]Indicates request verification for external verification of private keys in PaaS mode 
                                                            ...
                                                            <br>param1: [en]NA. [cn]NA.
                                                            <br>param2: [en]NA. [cn]NA.
                                                            <br>data: [en]Indicates the key. [cn]密钥. */ 
    ...
    CONF_MSG_USER_ON_HOST_CHANGE_IND       = 1101,     /**< [en]Indicates notification of changing the moderator. 
                                                            <br>[cn]主持人变更，所有人都能收到  
                                                            <br>param1: [en]Indicates the original host UserID. [cn]原主持人UserID.
                                                            <br>param2: [en]Indicates the new host UserID. [cn]新主持人UserID.
                                                            <br>data: [en]NA. [cn]NA. */
    CONF_MSG_USER_ON_HOST_CHANGE_CFM       = 1102,     /**< [en]Indicates notification of requesting to be the moderator 
                                                            <br>[cn]主持人申请结果  
                                                            <br>param1: [en]Indicates that the TC_OK request was successful. [cn]TC_OK申请成功.
                                                            <br>param2: [en]NA. [cn]NA.
                                                            <br>data: [en]NA. [cn]NA. */
    CONF_MSG_USER_ON_HOST_GIVE_IND         = 1103,     /**< [en]Indicates notification of assigning the role of moderator 
                                                            <br>[cn]主持人变更，被给予者会收到  
                                                            <br>param1: [en]Indicates the USERID assigned to the user. [cn]被赋予用户的USERID.
                                                            <br>param2: [en]NA. [cn]NA.
                                                            <br>data: [en]NA. [cn]NA. */
    CONF_MSG_USER_ON_HOST_GIVE_CFM         = 1104,     /**< [en]Indicates result of assigning the role of moderator
                                                            <br>[cn]主持人变更，设置者会收到  
                                                            <br>param1: [en]Indicates that the TC_OK operation was successful. [cn]TC_OK操作成功.
                                                            <br>param2: [en]NA. [cn]NA.
                                                            <br>data: [en]NA. [cn]NA. */

    CONF_MSG_USER_ON_PRESENTER_CHANGE_IND  = 1105,     /**< [en]Indicates notification of changing the presenter. 
                                                            <br>[cn]主讲人变更，所有人都能收到  
                                                            <br>param1: [en]Indicates the pre-change presenter ID. [cn]变更前主讲人ID.
                                                            <br>param2: [en]Indicates the speaker ID after the change. [cn]变更后主讲人ID.
                                                            <br>data: [en]NA. [cn]NA. */
    ...
    CONF_MSG_USER_ON_ENTER_IND             = 1109,     /**< [en]Indicates notification of a data user joining a meeting 
                                                            ...
                                                            <br>param1: [en]Indication 1: User in conference, 0: There is user notification in the conference. [cn]1：会议中用户加入,0：会中已有用户通知 .
                                                            <br>param2: [en]Indicates the role. [cn]角色.
                                                            <br>data: [en]Indicates the user information structure: TC_Conf_User_Record.. [cn]用户信息结构体：TC_Conf_User_Record. */
    ...
    CONF_MSG_USER_ON_MODIFY_IND            = 1111,     /**< [en]Indicates notification of updating data user information 
                                                            ...
                                                            <br>param1: [en]NA. [cn]NA.
                                                            <br>param2: [en]NA. [cn]NA.
                                                            <br>data: [en]Indicates TC_Conf_User_Record. [cn]TC_Conf_User_Record*. */
    CONF_MSG_USER_ON_MESSAGE_IND           = 1112,     /**< [en]Indicates notification of receiving a message from a user
                                                            <br>[cn]用户消息通知  
                                                            <br>param1: [en]NA. [cn]NA.                    
                                                            <br>param2: [en]NA. [cn]NA.
                                                            <br>data: [en]Indicates the message structure: USER_Message_Ind. [cn]消息结构体：USER_Message_Ind. */
    CONF_MSG_USER_ON_OFFLINE_IND           = 1113,     /**< [en]Indicates notification that a user is disconnected
                                                            <br>[cn]用户离线通知  
                                                            <br>param1: [en]Indicates the UserID of the broken user. [cn]断线的用户的UserID.
                                                            <br>param2: [en]NA. [cn]NA.
                                                            <br>data: [en]NULL. [cn]NULL. */
    CONF_MSG_USER_ON_RECONNECT_IND         = 1114,     /**< [en]Indicates user reconnection notification.
                                                            <br>[cn]用户离线恢复通知  
                                                            <br>param1: [en]Indicates that the UserID is reconnected. [cn]重连带用户UserID.
                                                            <br>param2: [en]NA. [cn]NA.
                                                            <br>data: [en]NULL. [cn]NULL. */
    ...
    CONF_MSG_ON_PHONE_ENTER_IND            = 1201,     /**< [en]Indicates notification of phone users joining a meeting
                                                            ...
                                                            <br>param1: [en]NA. [cn]NA.
                                                            <br>param2: [en]NA. [cn]NA.
                                                            <br>data: [en]Indicates the telephony user information structure: TC_Conf_Phone_Record. [cn]电话用户信息结构体：TC_Conf_Phone_Record. */   
    CONF_MSG_ON_PHONE_LEAVE_IND            = 1202,     /**< [en]Indicates notification of phone users leaving a meeting.
                                                            <br>[cn]电话用户离开  
                                                            <br>param1: [en]NA. [cn]NA.
                                                            <br>param2: [en]NA. [cn]NA.
                                                            <br>data: [en]Indicates the telephony user information structure: TC_Conf_Phone_Record. [cn]电话用户信息结构体：TC_Conf_Phone_Record d. */   
    CONF_MSG_ON_PHONE_STATUS_IND           = 1203,     /**< [en]Indicates notification of the phone session status 
                                                            <br>[cn]电话状态变化  
                                                            <br>param1: [en]Indicates the status of the conference call. [cn]电话会场状态.
                                                            <br>param2: [en]NA. [cn]NA.
                                                            <br>data: [en]NA. [cn]NA. */  
    CONF_MSG_ON_PHONE_SESSION_JOIN         = 1204,     /**< [en]Indicates notification of joining a phone session.
                                                            <br>[cn]电话模块加入通知  
                                                            <br>param1: [en]Indicates the join status. [cn]加入状态.
                                                            <br>param2: [en]NA. [cn]NA.
                                                            <br>data: [en]NA. [cn]NA. */  
    CONF_MSG_ON_PHONE_SESSION_OPEN         = 1205,     /**< [en]Indicates notification of opening a phone session. 
                                                            <br>[cn]电话模块打开通知  
                                                            <br>param1: [en]Indicates the open status. [cn]打开状态.
                                                            <br>param2: [en]NA. [cn]NA.
                                                            <br>data: [en]NA. [cn]NA. */  
    CONF_MSG_ON_PHONE_SESSION_CLOSE        = 1206,     /**< [en]Indicates notification of closing a phone session. 
                                                            <br>[cn]电话模块关闭通知  
                                                            <br>param1: [en]Indicates the exit cause. [cn]离开原因.
                                                            <br>param2: [en]NA. [cn]NA.
                                                            <br>data: [en]NA. [cn]NA. */  
    CONF_MSG_ON_PHONE_MUTE_STATUS_IND      = 1207,     /**< [en]Indicates notification of muting a phone session. 
                                                            <br>[cn]电话静音通知  
                                                            <br>param1: [en]Indicates mute_status mute state: TRUE Mute, FALSE resume.. [cn]mute_status 静音状态：TRUE 静音，FALSE 恢复.
                                                            <br>param2: [en]NA. [cn]NA.
                                                            <br>data: [en]NA. [cn]NA. */  
    ...
    CONF_MSG_ON_PHONE_ON_XML_STATUS_GET          = 1218,   /**< [en]Indicates getting the XML status 
                                                                ...
                                                                <br>param1: [en]0. [cn]0.
                                                                <br>param2: [en]0. [cn]0.
                                                                <br>data: [en]Indicates the status value. [cn]状态值 */ 
    CONF_MSG_ON_PHONE_IVR_REQ_IND                = 1219,   /**< [en]Indicates to enable / disable venue IVR playback 
                                                                <br>[cn]启用/禁用会场IVR放音  
                                                                <br>param1: [en]Indicates that the playback is true and playback is disabled. [cn]放音true,禁止放音false.
                                                                <br>param2: [en]NA. [cn]NA.
                                                                <br>data: [en]NA. [cn]NA. */ 
    CONF_MSG_ON_PHONE_MGW_MESSAGE_IND            = 1220,   /**< [en]Indicates MGW message 
                                                                <br>[cn]MGW 消息  
                                                                <br>param1: [en]Indicates the message type. [cn]消息类型.
                                                                <br>param2: [en]NA. [cn]NA.
                                                                <br>data: [en]Indicates the uint8 * message type. [cn]uint8* 消息类型. */    
    CONF_MSG_ON_PHONE_GET_PIN                    = 1221,   /**< [en]Indicates the user obtains the PIN code 
                                                                <br>[cn]用户获取PIN码  
                                                                <br>param1: [en]Indicates your UserID. [cn]自己的UserID.
                                                                <br>param2: [en]Indicates the PIN code. [cn]PIN码.
                                                                <br>data: [en]NA. [cn]无. */   
    CONF_MSG_ON_PHONE_CALL_FAILED                = 1222,   /**< [en]Indicates notification of phone failed 
                                                                <br>[cn]呼叫电话失败通知  
                                                                <br>param1: [en]0. [cn]0.
                                                                <br>param2: [en]NA. [cn]NA.
                                                                <br>data: [en]Indicates the string,a transferred phone number. [cn]字符串，转移的电话号码. */   
    ...
    CONF_MSG_ON_PHONE_EXTEND                     = 1224,   /**< [en]Indicates notification of phone extend
                                                                <br>[cn]电话会场延长通知  
                                                                <br>param1: [en]Indicates the time of the extension. [cn]延长的时间.
                                                                <br>param2: [en]NA. [cn]NA.
                                                                <br>data: [en]NA. [cn]NA. */   
    CONF_MSG_ON_PHONE_ROLLCALL_IND               = 1225,   /**< [en]Indicates naming enable or disable notification nvalue1 == 1 is on, nvalue1 == 0 is disabled 
                                                                ...
                                                                <br>param1: [en]Indication 0 is disabled, 1 is on. [cn]     0: 表示禁用,1:表示开启.
                                                                <br>param2: [en]NA. [cn]NA.
                                                                <br>data: [en]NA. [cn]NA. */    
    CONF_MSG_ON_PHONE_LOCK                       = 1226,   /**< [en]Indicates conference lock flag 
                                                                <br>[cn]会议锁定标记  
                                                                <br>param1: [en]Indicates the lock status. [cn]锁定状态. 
                                                                <br>param2: [en]0. [cn]0. 
                                                                <br>data: [en]NULL. [cn]NULL. */   
    CONF_MSG_ON_PHONE_CONF_MODE                  = 1227,   /**< [en]Indicates the conference mode change flag 
                                                                <br>[cn]会场模式变更标记   
                                                                <br>param1: [en]Indicates pattern type. voice, free, radio, chairman type, voice, free, radio, chairman. [cn]模式类型 ，声控，自由，广播，主席.
                                                                <br>param2: [en]Indicates mode status. [cn]模式状态.
                                                                <br>data: [en]NULL. [cn]NULL. */   
    CONF_MSG_ON_PHONE_RECORD_IND                 = 1228,   /**< [en]Indicates notification of recording the venue 
                                                                <br>[cn]会场被录制通知  
                                                                <br>param1: [en]Indicates the recording status. [cn]录制状态.
                                                                <br>param2: [en]0. [cn]0. 
                                                                <br>data: [en]NULL. [cn]NULL. */   
    CONF_MSG_ON_PHONE_CONF_INFO                  = 1229,   /**< [en]Indicates conference information feedback 
                                                                ...
                                                                <br>param1: [en]0. [cn]0. 
                                                                <br>param2: [en]0. [cn]0. 
                                                                <br>data: [en]Indicates site information of xml. [cn]会场信息xml. */   
    ...
    CONF_MSG_ON_PHONE_BROADCAST_MULTIFRAME       = 1231,   /**< [en]Indicates video broadcast multiframe
                                                                <br>[cn]广播多画面  
                                                                <br>param1: [en]Indicates status of broadcast multiframe. [cn]广播多画面状态. 
                                                                <br>param2: [en]0. [cn]0. 
                                                                <br>data: [en]Indicates userMT. [cn]用户MT号 */
    ...
    COMPT_MSG_VIDEO_ON_SWITCH                    = 2001,   /**< [en]Indicates notification of video change on the video devices of the current user and other users. 
                                                                <br>[cn]视频状态相关  
                                                                <br>param1: [en]Indicates 1: On 0: Off 2. Restart 4. Pause. [cn]1:打开 0:关闭  2.重启 4.暂停.
                                                                <br>param2: [en]Indicates whether the stream is high or low. [cn]是否拥有高低流.
                                                                <br>data: [en]Indicates the TC_VIDEO_PARAM * device specific information. [cn]TC_VIDEO_PARAM* 设备的一些具体信息. */     
    COMPT_MSG_VIDEO_ON_DEVICE_CHANGE             = 2002,   /**< [en]Indicates triggered by the insertion and removal of the current user's device
                                                                <br>[cn]设备插拨:(自己设备的插拨)  
                                                                <br>param1: [en]Indicates 1: Device is inserted, 0: Device dials out. [cn]1:设备插入,0:设备拨出.
                                                                <br>param2: [en]Indicates the user's device. [cn]是哪个用户的设备.
                                                                <br>data: [en]Indicates that the device ID number is a pointer to the type uint32 *. [cn]设备ID号是个指针，类型是uint32*. */     

    COMPT_MSG_VIDEO_ON_DEVICE_INFO               = 2003,   /**< [en]Indicates add or delete device 
                                                                <br>[cn]设备添加或是删除:(包括自己和别人)  
                                                                <br>param1: [en]Indicates  1: device is plugged in, 0: device pull out. [cn]1:设备插入,0:设备拨出.
                                                                <br>param2: [en]Indicates the number of devices, corresponding to the return parameters. [cn]设备数量,跟返回参数相对应.
                                                                <br>data:   [en]Indicates the TC_DEVICE_INFO * array pointer. [cn]TC_DEVICE_INFO*数组指针. */     
    COMPT_MSG_VIDEO_ON_DEVICE_CAPBILITY          = 2004,   /**< [en]Indicates device capability information 
                                                                <br>[cn]设备能力信息(暂不使用)  
                                                                <br>param1: [en]0. [cn]0. 
                                                                <br>param2: [en]Indicates the number of video devices. [cn]视频设备数量.
                                                                <br>data: [en]Indicates the video device enumeration structure, TC_VIDEO_PARAM. [cn]视频设备枚举结构体，TC_VIDEO_PARAM. */     
    ...
    COMPT_MSG_VIDEO_ON_USER_STATUSCHANGE         = 2007,   /**< [en]Indicates user status change 
                                                                <br>[cn]用户状态改变(暂不使用)  
                                                                <br>param1: [en]Indicates the user status. [cn]用户状态.
                                                                <br>param2: [en]Indicates the user id. [cn]用户id.
                                                                <br>data: [en]NULL. [cn]NULL. */     
    COMPT_MSG_VIDEO_ON_USERDEVICE_STATUSCHANGE   = 2008,   /**< [en]Indicates notification of status change (paused or resumed) of the video sender's device.
                                                                ...
                                                                <br>param1: [en]Indicates the sender's device status (1. Pause 2 Unpause). [cn]发送者设备状态(1.暂停 2取消暂停).
                                                                <br>param2: [en]Indicates UserID: User ID. [cn]UserID:用户ID.
                                                                <br>data:   [en]Indicates the device ID number, is a pointer, the type is uint32 *. [cn]设备ID号，是个指针，类型是uint32*. */     
    COMPT_MSG_VIDEO_ON_MAX_OPENVIDEO             = 2009,   /**< [en]Indicates notification of the maximum number of videos that can be opened simultaneously during a meeting 
                                                                <br>[cn]最大打开视频数  
                                                                <br>param1: [en]Indicates the maximum number of open videos. [cn]最大打开视频数.
                                                                <br>param2: [en]NA. [cn]NA.
                                                                <br>data: [en]NA. [cn]NA. */     
    COMPT_MSG_VIDEO_ON_NOTIFY                    = 2010,   /**< [en]Indicates notification of receiving a command for enabling or disabling the camera from other participants.
                                                                ...
                                                                <br>param1: [en]Indicates which user the UserID instruction is from. [cn]int UserID指令来自哪个用户.
                                                                <br>param2: [en]Indicates 1 is required to open the video command, 2 is required to close the video life. [cn]1被要求打开视频命令,2被要求关闭视频命.
                                                                <br>data: [en]Indicates the specific parameters required to open a device.TC_VIDEO_PARAM [cn]TC_VIDEO_PARAM*,被要求打开某个设备的具体参数. */     
    ...
    COMPT_MSG_VIDEO_FLOWCONTROL_NOTIFY           = 2011,   /**< [en]Indicates video flow control, the switch video parameter notification. 
                                                                ...
                                                                <br>param1: [en]Indicates the UserID. [cn]UserID.
                                                                <br>param2: [en]Indicates the DevideID. [cn]DevideID.
                                                                <br>data: [en]Indicates the video parameters after flow control.TC_VIDEO_PARAM [cn]TC_VIDEO_PARAM*,流控后的视频参数. */     
    ...
    COMPT_MSG_VIDEO_ON_GETDEVICE_NUM             = 2013,   /**< [en]Indicates the number of devices to obtain their own
                                                                <br>[cn]取得自己的设备个数  
                                                                <br>param1: [en]Indicates the number of devices. [cn]设备个数.
                                                                <br>param2: [en]0. [cn]0. 
                                                                <br>data: [en]NUll. [cn]NULL. */     
    COMPT_MSG_VIDEO_ON_GETDEVICE_INFO            = 2014,   /**< [en]Indicates obtains video device information
                                                                <br>[cn]取得自己的设备信息  
                                                                <br>param1: [en]Indicates the i-th device. [cn]第i个设备.
                                                                <br>param2: [en]Indicates the i-th device id. [cn]第i个设备id.
                                                                <br>data: [en]Indicates the i-th device information. [cn]第i个设备信息. */      

    COMPT_MSG_VIDEO_GETPARAM                     = 2015,   /**< [en]Indicates notification of obtaining the specified video parameters. 
                                                                <br>[cn]得到设置的视频参数 
                                                                <br>param1: [en]Indicates the device id. [cn]设备id
                                                                <br>param2: [en]0. [cn]0
                                                                <br>data: [en]Indicates the video parameters. [cn]视频参数 */     
    ...
    COMPT_MSG_VIDEO_ON_SWITCH_MOREINFO            = 2021,  /**< [en]Indicates notification of video change on the video devices of the current user and other users.
                                                                ...
                                                                <br>param1: [en]0: Indicates that the video is off. 1: Indicates that video is on. 2: Indicates that the paused state is on, that is, the open state. 4: Indicates a paused state. [cn]0:表示是关闭视频 1: 表示是打开视频 2: 表示取消暂停状态，即打开状态 4:表示暂停状态.
                                                                <br>param2: [en]Indicates whether the stream is high or low. [cn]是否拥有高低流.
                                                                <br>data: [en]Indicates some specific information about the device.TC_VIDEO_PARAM* [cn]TC_VIDEO_PARAM*,设备的一些具体信息. */       
    COMPT_MSG_VIDEO_ON_JOINCHANNEL                = 2022,  /**< [en]Indicates feedback for connecting the current user to high-bit-rate or low-bit-rate video channels 
                                                                <br>[cn]视频加入到哪个流  
                                                                <br>param1: [en]Indicates the user's device. [cn]是哪个用户的设备.
                                                                <br>param2: [en]Indicates the device ID number, is a pointer, the type is uint32 *. [cn]设备ID号，是个指针，类型是uint32*.
                                                                <br>data: [en]Indicates the type pointer.TC_VIDEO_DOUBLESTREAM_STATUS* [cn]TC_VIDEO_DOUBLESTREAM_STATUS* 类型指针. */       
    ...
    COMPT_MSG_VIDEO_ON_DEVICECAPBILITY_NUM        = 2024,  /**< [en]Indicates number of device capabilities
                                                                <br>[cn]设备能力个数  
                                                                <br>param1: [en]Indicates the number of device capabilities. [cn]设备能力个数.
                                                                <br>param2: [en]0. [cn]0.
                                                                <br>data: [en]NULL. [cn]NULL. */       
    COMPT_MSG_VIDEO_ON_DEVICECAPBILITY_INFO       = 2025,  /**< [en]Indicates device capability information
                                                                <br>[cn]设备能力信息  
                                                                <br>param1: [en]Indicates the device index. [cn]设备索引.
                                                                <br>param2: [en]Indicates the device ID. [cn]设备ID.
                                                                <br>data: [en]Indication TC_VIDEO_PARAM *. [cn]TC_VIDEO_PARAM *. */       

    COMPT_MSG_VIDEO_ON_FIRST_KEYFRAME             = 2026,  /**< [en]Indicates returns the first keyframe of decodeing
                                                                <br>[cn]返回解码后的第一个关键帧  
                                                                <br>param1: [en]Indicates the user ID. [cn]用户ID.
                                                                <br>param2: [en]Indicates the device ID. [cn]设备ID.
                                                                <br>data: [en]Indicates high flow or low flow. [cn]高流或是低流. */       

    
    COMPT_MSG_VIDEO_STARTRECORD_RESULT            = 2027,  /**< [en]Indicates whether start recording successful  
                                                                <br>[cn]开始录制是否成功  
                                                                <br>param1: [en]Indicates the device id. [cn]设备id
                                                                <br>param2: [en]Indicates the result. [cn]结果
                                                                <br>data: [en]NULL. [cn]NULL. */       
    ...
    COMPT_MSG_VIDEO_ON_SNAPSHOTDATA               = 2029,  /**< [en]Indicates returns the contents of the screenshot
                                                                ...
                                                                <br>param1: [en]Indicates the user id. [cn]用户id
                                                                <br>param2: [en]Indicates the device id. [cn]设备id
                                                                <br>data: [en]Indicates the screenshot data. [cn]截图数据 */       
    ...
    COMPT_MSG_VIDEO_MEDIA_SINGLE_SELECT_RESULT    = 2032,  /**< [en]Indicates returns of video selecting (AVC), and returns result, Recode ID 
                                                                <br>[cn]视频单流选看结果，返回结果, 选看用户ID. */       
    ...
    COMPT_MSG_AS_ON_SCREEN_DATA                = 2111,     /**< [en]Indicates notification of screen data update 
                                                                ...
                                                                <br>param1: [en]NA. [cn]NA.
                                                                <br>param2: [en]NA. [cn]NA.
                                                                <br>data: [en]Indicates the TC_AS_SCREENDATA structure. [cn]TC_AS_SCREENDATA结构. */   
    ...
    COMPT_MSG_AS_ON_SCREEN_BORDER              = 2114,     /**< [en]Indicates notification of screen data border (used to delete the black border) 
                                                                ...
                                                                <br>param1: [en]NA. [cn]NA.
                                                                <br>param2: [en]NA. [cn]NA.
                                                                <br>data: [en]Indicates TC_RECT2. [cn]TC_RECT2. */     
    COMPT_MSG_AS_ON_SCREEN_KEYFRAME            = 2115,     /**< [en]Indicates Indicates notification of screen key frame  (discarded)
                                                                ...
                                                                <br>param1: [en]xxxx. [cn]xxxx.
                                                                <br>param2: [en]xxxx. [cn] xxxx.
                                                                <br>data: [en]xxxx. [cn]xxxx. */     
    ...
    COMPT_MSG_AS_ON_SHARING_STATE              = 2121,     /**< [en]Indicates sharing status notification. 
                                                                <br>[cn]共享状态通知  
                                                                <br>param1: [en]Indicates SHSHARINGTYPE_DESKTOP  SHSHARINGTYPE_APP. [cn]SHSHARINGTYPE_DESKTOP  SHSHARINGTYPE_APP.
                                                                <br>param2: [en]Indicates AS_STATE_NULL,AS_STATE_VIEW,AS_STATE_START,AS_STATE_PAUSE. [cn]AS_STATE_NULL,AS_STATE_VIEW,AS_STATE_START,AS_STATE_PAUSE.
                                                                <br>data: [en]NULL. [cn]NULL. */     
    COMPT_MSG_AS_ON_SHARING_SESSION            = 2122,     /**< [en]Indicates sharing channel notification. 
                                                                <br>[cn]共享通道通知  
                                                                <br>param1: [en]Indicates AS_SESSION_CONNECT  AS_SESSION_OWNER. [cn]AS_SESSION_CONNECT  AS_SESSION_OWNER.
                                                                <br>param2: [en]Indicates AS_SESSION_DISCONNECT AS_SESSION_CONNECTED AS_SESSION_RECONNECTED AS_ACTION_DELETE AS_ACTION_ADD AS_ACTION_MODIFY. [cn]AS_SESSION_DISCONNECT AS_SESSION_CONNECTED AS_SESSION_RECONNECTED AS_ACTION_DELETE AS_ACTION_ADD AS_ACTION_MODIFY.
                                                                <br>data: [en]Indicates ID. [cn]ID. */     
    COMPT_MSG_AS_ON_PRIVILEGE                  = 2123,     /**< [en]Indicates sharing permission notification.
                                                                <br>[cn]共享权限通知  
                                                                <br>param1: [en]Indicates AS_PRIVILEGETYPE_CONTROL AS_PRIVILEGETYPE_ANNOTATION. [cn]AS_PRIVILEGETYPE_CONTROL AS_PRIVILEGETYPE_ANNOTATION.
                                                                <br>param2: [en]Indicates AS_ACTION_REQUEST. [cn]AS_ACTION_REQUEST.
                                                                <br>data: [en]Indicates ID (Permission Request User). [cn]ID（权限申请用户）. */     
    COMPT_MSG_AS_ON_MODULE                     = 2124,     /**< [en]Indicates notification of updating the module status (unused currently)    
                                                                <br>[cn]共享权限通知 (SHCBK_STATE_MODULE,0, State, NULL),   
                                                                <br>param1: [en]NA. [cn]NA.
                                                                <br>param2: [en]Indicates state. [cn]State.
                                                                <br>data: [en]NULL. [cn]NULL. */    
    ...
    COMPT_MSG_AS_ON_CHANNEL                    = 2126,     /**< [en]Indicates notification of joining or exiting a channel.
                                                                <br>[cn]共享权限通知 (SHCBK_STATE_CHANNEL,NodeID, Type, Action)  
                                                                <br>param1: [en]Indicates the ID. [cn]ID.
                                                                <br>param2: [en]Indicates AS_CHANNEL_TYPE_NORMAL AS_CHANNEL_TYPE_LOW_QUALITY AS_CHANNEL_TYPE_TP. [cn]AS_CHANNEL_TYPE_NORMAL AS_CHANNEL_TYPE_LOW_QUALITY AS_CHANNEL_TYPE_TP.
                                                                <br>data: [en]Indicates AS_ACTION_DELETE AS_ACTION_ADD. [cn]AS_ACTION_DELETE AS_ACTION_ADD. */    
    ...
    COMPT_MSG_AS_ON_USERDEFINE_MSG             = 2151,     /**< [en]Indicates user message notification (received by the receive party). 
                                                                <br>[cn]用户自定义消息通知  
                                                                <br>param1: [en]Indicates the message type. [cn]消息类型.
                                                                <br>param2: [en]Indicates the source user ID. [cn]源用户ID.
                                                                <br>data: [en]Indicates user data. [cn]用户数据. */     
    COMPT_MSG_AS_ON_USERDEFINE_REMOTE_SHARE    = 2152,     /**< [en]Indicates remote invitation screen sharing 
                                                                <br>[cn]远程邀请屏幕共享  
                                                                <br>param1: [en]Indicates the message type. [cn]消息类型.
                                                                <br>param2: [en]Indicates screen sharing parameters. [cn]屏幕共享参数.
                                                                <br>data: [en]Indicates the source user ID. [cn]源用户ID. */    
    ...
    COMPT_MSG_AS_ON_XML_GET_PARAM              = 2160,     /**< [en]Indicates to get the XML parameters that Android uses
                                                                ...
                                                                <br>param1: [en]0. [cn]0.
                                                                <br>param2: [en]Indicates 0. [cn]0.
                                                                <br>data: [en]Indicates screen sharing parameters. [cn]屏幕共享的参数 */ 

    COMPT_MSG_AS_ON_JSON_GET_PARAM             = 2161,     /**< [en]Indicates to get screen sharing parameters
                                                                <br>[cn]获取屏幕共享参数  
                                                                <br>param1: [en]Indicates the parameter type. [cn]参数类型.
                                                                <br>param2: [en]Indicates the parameter data length. [cn]参数数据长度.
                                                                <br>data: [en]NULL. [cn]NULL. */    
    COMPT_MSG_AS_ON_JSON_GET_DISPLAYINFO       = 2162,     /**< [en]Indicates to get display information 
                                                                <br>[cn]获取显示器信息  
                                                                <br>param1: [en]Indicates the number of displays. [cn]显示器数量.
                                                                <br>param2: [en]0. [cn]0.
                                                                <br>data: [en]NULL. [cn]NULL. */    
    COMPT_MSG_AS_ON_AUX_DEC_FRIST_FRAME           = 2163,            /**< [en]notify aux flow decode first frame
                                                                <br>[cn]辅流解码第一帧成功的通知 
                                                                <br>param1: [en]xxxx. [cn]NA.
                                                                <br>param2: [en]xxxx. [cn]NA.
                                                                <br>data: [en]xxxx. [cn]NA. */ 
    ...
    COMPT_MSG_DS_ON_DOC_NEW                = 2201,         /**< [en]Indicates create a new document 
                                                                <br>[cn]新建一个文档  
                                                                <br>param1: [en]Indicates the document ID. [cn]文档ID.
                                                                <br>param2: [en]NA. [cn]NA.
                                                                <br>data: [en]Indicates NULL or document name (utf8 string). [cn]NULL或文档名（utf8字符串）. */ 
    ...
    COMPT_MSG_DS_ON_PAGE_NEW               = 2203,         /**< [en]Indicates create a new page 
                                                                <br>[cn]新建一页  
                                                                <br>param1: [en]Indicates the document ID. [cn]文档ID.
                                                                <br>param2: [en]Indicates the page ID. [cn]页ID .
                                                                <br>data: [en]NULL. [cn]NULL. */  
    ...
    COMPT_MSG_DS_ON_DOCLOAD_FINISH         = 2209,         /**< [en]Indicates notification that a document is loaded 
                                                                <br>[cn]加载文档结束  
                                                                <br>param1: [en]Indicates the document ID. [cn]文档ID.
                                                                <br>param2: [en]Indicates the document loading results, as defined in TcResult. [cn]文档加载结果，参考TcResult中的定义.
                                                                <br>data: [en]NULL. [cn]NULL. */  
    ...
    COMPT_MSG_DS_ANDROID_DOC_COUNT         = 2215,         /**< [en]Indicates document count,for android 
                                                                ...
                                                                <br>param1: [en]Indicates the number of documents. [cn]文档数量.
                                                                <br>param2: [en]0. [cn]0.
                                                                <br>data: [en]NULL. [cn]NULL. */  
    ...
    COMPT_MSG_DS_XML_SYNC_INFO             = 2218,         /**< [en]Indicates synchronization information 
                                                                ...
                                                                <br>param1: [en]0. [cn]0.
                                                                <br>param2: [en]0. [cn]0.
                                                                <br>data: [en]Indicates document synchronization information. [cn]文档同步信息. */
    ...
    COMPT_MSG_DS_JSON_SYNC_INFO            = 2220,         /**< [en]Indicates synchronization information 
                                                                <br>[cn]同步信息  
                                                                <br>param1: [en]Indicates the current document id on the server. [cn]服务器上的当前文档id.
                                                                <br>param2: [en]Indicates the current page id on the server. [cn]服务器上的当前页id.
                                                                <br>data: [en]NULL. [cn]NULL. */  
    COMPT_MSG_DS_JSON_DOC_COUNT            = 2221,         /**< [en]Indicates the number of documents 
                                                                <br>[cn]文档数量  
                                                                <br>param1: [en]0. [cn]0.
                                                                <br>param2: [en]Indicates the number of documents . [cn]文档数量.
                                                                <br>data: [en]NULL. [cn]NULL. */  
    ...
    COMPT_MSG_DS_JSON_PAGEINFO             = 2227,         /**< [en]Indicates to get page information 
                                                                ...
                                                                <br>param1: [en]0. [cn]0.
                                                                <br>param2: [en]0. [cn]0.
                                                                <br>data: [en]Indicates the page information structure. DsPageInfo[cn]页面信息结构体 DsPageInfo. */  
    COMPT_MSG_DS_JSON_DOCINFO              = 2228,         /**< [en]Indicates to get document information 
                                                                <br>[cn]获取文档信息  
                                                                <br>param1: [en]0. [cn]0.
                                                                <br>param2: [en]0. [cn]0.
                                                                <br>data: [en]Indicates the document information structure. DsDocInfo [cn]文档信息结构体 DsDocInfo. */  
    ...
    COMPT_MSG_FT_ON_FILE_REMOVE            = 2301,         /**< [en]Indicates notification of deleting a file 
                                                                <br>[cn]文件项删除  
                                                                <br>param1: [en]Indicates the nFileHandle file id. [cn]nFileHandle文件标识.
                                                                <br>param2: [en]NA. [cn]NA.
                                                                <br>data: [en]NULL. [cn]NULL. */  
    COMPT_MSG_FT_ON_FILE_INFO              = 2302,         /**< [en]Indicates notification of adding or updating a file 
                                                                ...
                                                                <br>param1: [en]Indicates the nFileHandle file id. [cn]nFileHandle文件标识.
                                                                <br>param2: [en]NA. [cn]NA.
                                                                <br>data: [en]Indicates TC_FILE_INFO. [cn]TC_FILE_INFO*. */  
    COMPT_MSG_FT_ON_PROGRESS               = 2303,         /**< [en]Notification of progress of file download or upload.
                                                                <br>[cn]文件项下载或上传进度通知  
                                                                <br>param1: [en]Indicates the nFileHandle file id. [cn]nFileHandle文件标识.
                                                                <br>param2: [en]Indicates the progress of the download or upload, in percentage.. [cn]下载或上传进度，单位：百分比.
                                                                <br>data: [en]NULL. [cn]NULL. */  
    COMPT_MSG_FT_ON_END                    = 2304,         /**< [en]Indicates notification of end (or failure) of file download or upload
                                                                <br>[cn]文件项上传或下载结束通知  
                                                                <br>param1: [en]Indicates the nFileHandle file id. [cn]nFileHandle文件标识.
                                                                <br>param2: [en]Indicates the options are as follows:success: TC_OK, failure: TC_FAILURE or other error code. [cn]成功则:TC_OK,失败:TC_FAILURE或其它错误码.
                                                                <br>data: [en]NULL. [cn]NULL. */ 
    ...
    COMPT_MSG_CHAT_ON_GROUP_CREATE         = 2400,         /**< [en]Indicates Indicates notification of group creation received only by the group creator.
                                                                <br>[cn]聊天群创建成功通知  
                                                                <br>param1: [en]Indicates Indicates the options are as follows:success: TC_OK, failure: TC_FAILURE or other error code. [cn]成功TC_OK;失败TC_FAILURE.
                                                                <br>param2: [en]Indicates 0. [cn]0.
                                                                <br>data: [en]Indicates TC_GROUP_INFO*. [cn]TC_GROUP_INFO*. */  
    COMPT_MSG_CHAT_ON_GROUP_INFO_MODIFIED  = 2401,         /**< [en]Indicates notification of changing the group information (only the group member list changes) 
                                                                <br>[cn]聊天群信息修改通知  
                                                                <br>param1: [en]0. [cn]0.
                                                                <br>param2: [en]Indicates Indicates the options are as follows:REASON_GROUP_USER_ADD / / is invited into the group, REASON_GROUP_USER_DEL / / was kicked out of the group. [cn]REASON_GROUP_USER_ADD//被邀请入组,REASON_GROUP_USER_DEL //被踢除出组.
                                                                <br>data: [en]Indicates TC_GROUP_INFO*. [cn]TC_GROUP_INFO*. */  
    ...
    COMPT_MSG_CHAT_ON_GROUP_KICKOUT        = 2403,         /**< [en]Indicates notification of kicking a user out of a group (received by the user who is kicked out) 
                                                                <br>[cn]收到被踢出群聊的通知  
                                                                <br>param1: [en]Indicates the group ID. [cn]群组ID.
                                                                <br>param2: [en]0. [cn]0.
                                                                <br>data: [en]NULL. [cn]NULL. */  
    ...
    COMPT_MSG_CHAT_ON_GROUP_USER_ONLINE    = 2405,         /**< [en]Indicates notification that a user gets online during the group instant messaging (received by all online group members). 
                                                                ...
                                                                <br>param1: [en]Indicates the group ID. [cn]群组ID.
                                                                <br>param2: [en]0. [cn]0.
                                                                <br>data: [en]Indicates user ID uint32 *. [cn]上线者用户ID uint32*. */  
    COMPT_MSG_CHAT_ON_GROUP_USER_OFFLINE   = 2406,         /**< [en]Notification that a user is disconnected during the group instant messaging (received by all online group members). 
                                                                ...
                                                                <br>param1: [en]Indicates the group ID. [cn]群组ID.
                                                                <br>param2: [en]0. [cn]0.
                                                                <br>data: [en]Indicates the user ID of the downline uint32 *. [cn]下线者用户ID uint32*. */  
    COMPT_MSG_CHAT_ON_GROUP_USER_LEAVE     = 2407,         /**< [en]Notification of leaving a group. 
                                                                <br>[cn]退出群组通知  
                                                                <br>param1: [en]Indicates the group ID. [cn]群组ID.
                                                                <br>param2: [en]Indicates the exit cause. [cn]离开原因。取值：REASON_LEAVE_GROUP_SELF 自己离开,REASON_LEAVE_GROUP_KICKED 被踢,REASON_LEAVE_GROUP_OTHER 组内其他成员离开.
                                                                <br>data: [en]Indicates to Leave by Userid uint32 *. [cn]离开者Userid uint32*. */  
    COMPT_MSG_CHAT_ON_RECV_MSG             = 2408,         /**< [en]Indicates notification of receiving an IM. 
                                                                <br>[cn]收到聊天消息  
                                                                <br>param1: [en]0. [cn]O.
                                                                <br>param2: [en]0. [cn]O.
                                                                <br>data: [en]Indicates the TC_CHAT_MSG * type. [cn]TC_CHAT_MSG* 类型. */   
    COMPT_MSG_CHAT_ON_PUBLIC_MSG_REMOVE    = 2409,         /**< [en]Indicates notification of deleting public IMs (received by all participants). 
                                                                <br>[cn]删除公聊消息通知  
                                                                <br>param1: [en]Indicates the message sender user ID. [cn]消息发送者用户ID.
                                                                <br>param2: [en]Indicates the serial number of the public IM that was deleted (if nValue2 is 0, all public IMs sent by the user with the ID nValue1 have been deleted). [cn]被删除公共即时消息的序列号（如果nValue2值为0，表示ID为nValue1的用户发送的所有公共即时消息已被删除）.
                                                                <br>data:   [en]NULL. [cn]NULL. */  
    ...
    COMPT_MSG_MS_ON_STARTPLAY              = 2501,         /**< [en]Indicates that play starts. 
                                                                <br>[cn]开始播放  
                                                                <br>param1: [en]Indicates the tcresult. [cn]TcResult.
                                                                <br>param2: [en]0. [cn]0.
                                                                <br>data: [en]Indicates the play file name in Utf8 format. [cn]Utf8格式的播放文件名. */  
    ...
    COMPT_MSG_MS_ON_MIDPLAY                = 2506,         /**< [en]Indicates the midway participants play.
                                                                ...
                                                                <br>param1: [en]Indicates the tcresult. [cn]TcResult.
                                                                <br>param2: [en]Reserved. [cn]保留.
                                                                <br>data: [en]Indicates the Double pointer: Playback position. [cn]Double指针：播放位置. */ 
    COMPT_MSG_MS_ON_PLAYERSTATE_CHANGE     = 2507,         /**< [en]Indicates that the player status changes. 
                                                                <br>[cn]播放器状态变更  
                                                                <br>param1: [en]Indicates the tcresult. [cn]TcResult.
                                                                <br>param2: [en]Reserved. [cn]保留.
                                                                <br>data: [en]Indicates the PLAYER_STATUS pointer: Playback status.. [cn]PLAYER_STATUS指针：播放状态. */ 
    COMPT_MSG_MS_ON_MEDIA_INFO             = 2508,         /**< [en]Indicates media playback information. 
                                                                <br>[cn]媒体播放信息. 
                                                                <br>param1: [en]Indicates 1. [cn]1.
                                                                <br>param2: [en]Indicates 0. [cn]0.
                                                                <br>data: [en]Indicates the media file name. [cn]媒体文件名 */ 
    ...
    COMPT_MSG_POLLING_ON_POLL_ID_CHANGED               = 2605,         /**< [en]Indicates the notification of changing the questionnaire ID and transmitting the questionnaire successfully 
                                                                            <br>[cn]问卷ID发生变化  
                                                                            <br>param1: [en]Indicates the new ID of the questionnaire (positive integer). [cn]问卷新ID（正整数）.
                                                                            <br>param2: [en]Indicates the questionnaire old ID (integer less than -1). [cn]问卷旧ID（小于-1的整数）.
                                                                            <br>data: [en]NULL. [cn]NULL. */  
    COMPT_MSG_POLLING_ON_GLOBAL_PARAM_UPDATE           = 2606,         /**< [en]Indicates the notification of updating the global parameters. 
                                                                            <br>[cn]全局参数发生变化  
                                                                            <br>param1: [en]Indicates 0. [cn]0.
                                                                            <br>param2: [en]Indicates 0. [cn]0.
                                                                            <br>data: [en]Indicates the ParamUpdateData * type. [cn]ParamUpdateData*类型. */  
    COMPT_MSG_POLLING_ON_POLL_PARAM_UPDATE             = 2607,         /**< [en]Indicates the notification of updating the questionnaire parameters
                                                                            <br>[cn]问卷参数更新消息  
                                                                            <br>param1: [en]Indicates questionnaire ID (non-negative). [cn]问卷ID（非负）.
                                                                            <br>param2: [en]Indicates the questionnaire parameter ID. [cn]问卷参数ID.
                                                                            <br>data:   [en]Indicates the ParamUpdateData * type. [cn]ParamUpdateData*类型. */   

   
    COMPT_MSG_POLLING_XML_ON_NEW_POLL                  = 2610,         /**< [en]Indicates to create a new questionnaire and return the questionnaire ID 
                                                                            <br>[cn]创建新问卷，返回问卷ID  
                                                                            <br>param1: [en]Indicates the questionnaire ID. [cn]问卷ID.
                                                                            <br>param2: [en]Indicates 0. [cn]0.
                                                                            <br>data:   [en]NULL. [cn]NULL. */     
    COMPT_MSG_POLLING_XML_ON_NEW_QUESTION              = 2611,         /**< [en]Indicates to create a new question and return the question ID 
                                                                            <br>[cn]创建新问题，返回问题ID  
                                                                            <br>param1: [en]Indicates the questionnaire ID. [cn]问卷ID.
                                                                            <br>param2: [en]Indicates the problem id. [cn]问题id.
                                                                            <br>data:   [en]NULL. [cn]NULL. */     
    COMPT_MSG_POLLING_XML_ON_GET_POLL_TITLE            = 2612,         /**< [en]Indicates to get the questionnaire title 
                                                                            <br>[cn]获取问卷标题  
                                                                            <br>param1: [en]Indicates the questionnaire ID. [cn]问卷ID.
                                                                            <br>param2: [en]Indicates 0. [cn]0.
                                                                            <br>data:   [en]Indicates the name of the questionnaire. [cn]问卷名. */     
    ...
    COMPT_MSG_POLLING_XML_ON_GET_QUESTION              = 2618,         /**< [en]Indicates to get question type,question content,question options about one questionnaire 
                                                                            ...
                                                                            <br>param1: [en]Indicates the questionnaire ID. [cn]问卷ID.
                                                                            <br>param2: [en]Indicates the problem id. [cn]问题id.
                                                                            <br>data:   [en]Indicates problematic XML. [cn]问题XML. */    
    ...
    COMPT_MSG_POLLING_XML_ON_GET_QUESTIONID_BYINDEX    = 2620,         /**< [en]Indicates to get question ID by index 
                                                                            <br>[cn]根据索引获取问题ID  
                                                                            <br>param1: [en]Indicates the questionnaire ID. [cn]问卷ID.
                                                                            <br>param2: [en]Indicates the questionnaire index. [cn]问卷索引.
                                                                            <br>data:   [en]Indicates the problem id. [cn]问题id. */    
    COMPT_MSG_POLLING_XML_ON_GET_QUESTION_ANSWER       = 2621,         /**< [en]Indicates to get answer of the question. 
                                                                            <br>[cn]获取问题答案  
                                                                            <br>param1: [en]Indicates the questionnaire ID. [cn]问卷ID.
                                                                            <br>param2: [en]Indicates the problem id. [cn]问题id.
                                                                            <br>data:   [en]Indicates the answer XML. [cn]答案XML. */    
    ...
    COMPT_MSG_POLLING_XML_ON_LOAD_FROM_FILE            = 2623,         /**< [en]Indicates to get the number of questionnaires that are loaded and questionnaire ID. 
                                                                            ...
                                                                            <br>param1: [en]Indicates 0. [cn]0.
                                                                            <br>param2: [en]Indicates 0. [cn]0.
                                                                            <br>data:   [en]Indicates the questionnaire ID. [cn]问卷ID. */    
    ...
    COMPT_MSG_AUDIO_ON_AUDIO_MUTE_ALL_ATTENDEE         = 2701,         /**< [en]Indicates to site muting notification. 
                                                                            <br>[cn]收到会场静音消息  
                                                                            <br>param1: [en]The options are as follows:TRUE to set the venue to be muted FALSE to set the venue to non-mute state. [cn]int nValue1: TRUE:设置会场为静音状态 FALSE:设置会场为非静音状态.
                                                                            <br>param2: [en]Indicates 0. [cn]0.
                                                                            <br>data:   [en]NULL. [cn]NULL. */  
    ...
    COMPT_MSG_AUDIO_ON_ENGINE_DEVICE_CHANGE            = 2702,         /**< [en]Indicates notification of the hot swap of an audio device 
                                                                            ...
                                                                            <br>param1: [en]Indicates 0. [cn]0.
                                                                            <br>param2: [en]Indicates 0. [cn]0.
                                                                            <br>data:   [en]Indicates the audio hot-swap structure tag_HotPlug. [cn]音频热插拔结构体 tag_HotPlug. */  
    COMPT_MSG_AUDIO_ON_ENGINE_RUNNING_ERR_NOTIFY       = 2703,         /**< [en]Indicates notification of HME exceptions
                                                                            <br>[cn]引擎系统运行时错误  
                                                                            <br>param1: [en]Indicates 0. [cn]0.
                                                                            <br>param2: [en]Indicates 0. [cn]0.
                                                                            <br>data:   [en]Indicates 0. [cn]0. */  
    ...
    COMPT_MSG_AUDIO_ON_AUDIO_NEGOTIATE_CODEC           = 2706,         /**< [en]Indicates the result of the codec negotiation with the server for the server mixing 
                                                                            <br>[cn]与服务器协商编解码结果  
                                                                            <br>param1: [en]The options are as follows.TC_OK: Negotiation successful; TC_FAILURE: Negotiation failed. [cn]int nValue1: TC_OK:协商成功  TC_FAILURE：协商失败.
                                                                            <br>param2: [en]The options are as follows. 0: Establish server mix channel; 1: Turn off the server mix channel. [cn]long nValue2: 0:建立服务器混音通道 1:关闭服务器混音通道.
                                                                            <br>data:   [en]Indicates the error code. [cn]错误码. */  
    COMPT_MSG_AUDIO_ON_AUDIO_ACTION                    = 2707,         /**< [en]Indicates notification of receiving the microphone control command or starting or stopping private voice chat 
                                                                            ...
                                                                            <br>param1: [en]Indicates AUDIO_OPEN_MIC: Turns on; AUDIO_CLOSE_MIC: Turns off. [cn]int nValue1:AUDIO_OPEN_MIC：打开 AUDIO_CLOSE_MIC：关闭
                                                                                        [en]Indicates AUDIO_MUTE_MIC: Mute AUDIO_UNMUTE_MIC: Unmute AUDIO_PRIVATE_CHAT_ENTER: Go to Private Chat. [cn]AUDIO_MUTE_MIC：静音 AUDIO_UNMUTE_MIC：取消静音 AUDIO_PRIVATE_CHAT_ENTER：进入私聊
                                                                                        [en]Indicates AUDIO_PRIVATE_CHAT_LEAVE: Leaving the whisper; AUDIO_OPEN_MIC_TP: Operation from Smart; AUDIO_CLOSE_MIC_TP: Operation from Smart. [cn]AUDIO_PRIVATE_CHAT_LEAVE：离开私聊 AUDIO_OPEN_MIC_TP：来自智真的操作 AUDIO_CLOSE_MIC_TP：来自智真的操作
                                                                                        [en]Indicates AUDIO_OPEN_SPEAKER_TP: Operation from True. AUDIO_CLOSE_SPEAKER_TP: Operation from True. [cn]AUDIO_OPEN_SPEAKER_TP：来自智真的操作 AUDIO_CLOSE_SPEAKER_TP：来自智真的操作.
                                                                            <br>param2: [en]Indicates long nValue2 0. [cn]long nValue2 0.
                                                                            <br>data:   [en]Indicates the uid32 * userid of the operator who initiated the command. [cn]uint32* 发起命令的操作者的userid. */   
    COMPT_MSG_AUDIO_ON_AUDIO_MAX_OPEN_DEVICE           = 2708,         /**< [en]Indicates notification of the maximum number of devices that can be enabled simultaneously
                                                                            <br>[cn]最大容许打开的设备数量  
                                                                            <br>param1: [en]Indicates the maximum number of devices that are currently open.. [cn]int nValue1 当前最大容许打开的设备数量.
                                                                            <br>param2: [en]Indicates long nValue2 0. [cn]long nValue2 0.
                                                                            <br>data:   [en]null. [cn]null. */    
    COMPT_MSG_AUDIO_ON_AUDIO_DEVICE_STATUS_CHANGE      = 2709,         /**< [en]Indicates notification of changing the status of a participant's device
                                                                            <br>[cn]音频设备状态通知 mic  
                                                                            <br>param1: [en]Indicates the int value (device type): AUDIO_MIC = 0 or AUDIO_SPEAKER = 1. [cn]int值（设备类型）:AUDIO_MIC=0或者AUDIO_SPEAKER=1.
                                                                            <br>param2: [en]Indicates the options are as follows.UDIO_STATUS_OPEN = 0,AUDIO_STATUS_CLOSE=1,AUDIO_STATUS_MUTE=2,AUDIO_STATUS_NO_DEVICE=3.[cn]long值（设备状态）:AUDIO_STATUS_OPEN = 0,AUDIO_STATUS_CLOSE=1,AUDIO_STATUS_MUTE=2,AUDIO_STATUS_NO_DEVICE=3.
                                                                            <br>data: [en]Indicates the userid of the device state change. [cn]uint32* 设备状态变更者的userid. */   
    COMPT_MSG_AUDIO_ON_AUDIO_MGW_EXCEPTION             = 2710,         /**< [en]Indicates MGW exception. 
                                                                            <br>[cn]MGW异常  
                                                                            <br>param1: [en]Indicates the exception type. [cn]异常类型.
                                                                            <br>param2: [en]Indicates 0. [cn]0.
                                                                            <br>data:   [en]Indicates 0. [cn]0. */   
    COMPT_MSG_AUDIO_ON_AUDIO_MGWVA_NEGOTIATE_CODEC     = 2711,         /**< [en]Indicates notification of establishing or disabling a voice assistant channel. 
                                                                            <br>[cn]语音助理  
                                                                            <br>param1: [en]Indicates the options are as follows.TC_OK: negotiation succeeded, TC_FAILURE: negotiation failed. [cn]int nValue1: TC_OK:协商成功,TC_FAILURE：协商失败.
                                                                            <br>param2: [en]Indicates the options are as follows.0: Establish the server mix channel, 1: Turn off the server mix channel. [cn]long nValue2: 0:建立服务器混音通道,1:关闭服务器混音通道.
                                                                            <br>data:   [en]Indicates the error code. [cn]错误码. */   
    ...
    COMPT_MSG_AUDIO_ON_SYSTEM_SPEAKER_VOLUME           = 2713,         /**< [en]Indicates the callback message received when the system speaker volume is changed 
                                                                            <br>[cn]系统扬声器音量改变通知  
                                                                            <br>param1: [en]Indicates the int value.system speaker volume, range from 0 to 100. [cn]int值（系统扬声器音量，范围[0, 100]）.
                                                                            <br>param2: [en]Indicates 0. [cn]0.
                                                                            <br>data:   [en]Indicates 0. [cn]0. */  
    COMPT_MSG_AUDIO_ON_SYSTEM_MIC_VOLUME               = 2714,         /**< [en]Indicates the callback message received when the system mic volume is changed 
                                                                            <br>[cn]系统麦克风音量改变通知  
                                                                            <br>param1: [en]Indicates the int value.system speaker volume, range from 0 to 100. [cn]int值（系统麦克风音量，范围[0, 100]）.
                                                                            <br>param2: [en]Indicates 0. [cn]0.
                                                                            <br>data:   [en]Indicates 0. [cn]0. */  
    ...
    COMPT_MSG_AUDIO_ON_XML_MIC_VOLUME                  = 2780,         /**< [en]Indicates notification of obtaining the microphone volume. 
                                                                            <br>[cn]Mic音量变更通知  
                                                                            <br>param1: [en]Indicates the volume. [cn]音量.
                                                                            <br>param2: [en]Indicates 0. [cn]0.
                                                                            <br>data:   [en]NULL. [cn]NULL. */   
    ...
    COMPT_MSG_AUDIO_JSON_DEVICE_VOLUME                 = 2782,         /**< [en]Indicates the audio device volume change notification. 
                                                                            <br>[cn]音频设备音量变更通知  
                                                                            <br>param1: [en]Indicates 0. [cn]0.
                                                                            <br>param2: [en]Indicates the volume. [cn]音量.
                                                                            <br>data:   [en]NULL. [cn]NULL. */
    ...
    COMPT_MSG_AUDIO_JSON_DEVICENUM                     = 2784,         /**< [en]Indicates the number of JSON audio devices 
                                                                            <br>[cn]JSON音频设备数量  
                                                                            <br>param1: [en]Indicates 0. [cn]0.
                                                                            <br>param2: [en]Indicates the number of devices. [cn]设备数量.
                                                                            <br>data:   [en]NULL. [cn]NULL. */
    COMPT_MSG_AUDIO_JSON_DEVICEINFO                    = 2785,         /**< [en]Indicates JSON audio device information. 
                                                                            <br>[cn]JSON音频设备信息  
                                                                            <br>param1: [en]Indicates 0. [cn]0.
                                                                            <br>param2: [en]Indicates the audio device information structure TC_AUDIO_DEVICE_INFO. [cn]音频设备信息结构体 TC_AUDIO_DEVICE_INFO.
                                                                            <br>data:   [en]NULL. [cn]NULL. */
    ...
    COMPT_MSG_WB_XML_ON_COPY_PAGE                      = 2812,         /**< [en]Indicates to copy page then back(on android) 
                                                                            ...
                                                                            <br>param1: [en]Indicates the document ID. [cn]文档ID.
                                                                            <br>param2: [en]Indicates the page ID. [cn]新页ID.
                                                                            <br>data:   [en]NULL. [cn]NULL. */   
    ...
    COMPT_MSG_WB_JSON_PAGEID_BYNO                      = 2825,         /**< [en]Indicates to get page ID by page number 
                                                                            <br>[cn]通过页码获取页面ID  
                                                                            <br>param1: [en]Indicates the page ID. [cn]页ID.
                                                                            <br>param2: [en]Indicates 0. [cn]0.
                                                                            <br>data:   [en]NULL. [cn]NULL. */   
    COMPT_MSG_WB_JSON_PAGEINFO                         = 2826,         /**< [en]Indicates to get page information 
                                                                            ...
                                                                            <br>param1: [en]Indicates 0. [cn]0.
                                                                            <br>param2: [en]Indicates 0. [cn]0.
                                                                            <br>data:   [en]Indicates the page information definition structure DsPageInfo. [cn]页面信息定义结构体 DsPageInfo. */  
    COMPT_MSG_WB_JSON_DOCINFO                          = 2827,         /**< [en]Indicates to get document information 
                                                                            <br>[cn]获取文档信息  
                                                                            <br>param1: [en]Indicates 0. [cn]0.
                                                                            <br>param2: [en]Indicates 0. [cn]0.
                                                                            <br>data:   [en]Indicates 0. [cn]页面信息定义结构体 DsPageInfo. */  
    ...
    COMPT_MSG_ANNO_CREATE_NEWID        = 2901,       /**< [en]Indicates to create an ANNO 
                                                          <br>[cn]新建一个标注  
                                                          <br>param1: [en]Indicates the serial number. [cn]序列号.
                                                          <br>param2: [en]Indicates the id. [cn]id.
                                                          <br>data:   [en]NULL. [cn]NULL. */     
    ...
    COMPT_MSG_ANNO_HITTEST             = 2904,       /**< [en]Indicates whether a point is dropped on the label.
                                                          ...
                                                          <br>param1: [en]Indicates the serial number. [cn]序列号.
                                                          <br>param2: [en]Indicates the id. [cn]id
                                                          <br>data:   [en]Indicates the result. [cn]结果 */      
    ...
    COMPT_MSG_ANNO_GETINFO             = 2906,       /**< [en]Indicates that the callout information is obtained.
                                                          ...
                                                          <br>param1: [en]Indicates the serial number. [cn]序列号.
                                                          <br>param2: [en]Indicates the id. [cn]id.
                                                          <br>data:   [en]Indicates label information. [cn]标注信息. */  
