 ...
 * @defgroup AuxShare
 * @ingroup AdvancedAPI
 * @brief Auxiliary stream sharing   
 *        <br>辅流共享
 * @{
 **/
...
//为了1、避免把专业性的术语暴露给上层；2、统一H323和SIP协议，增加本接口。
//本接口用于替代原tup_call_reinvite接口，原tup_call_reinvite接口逐步废除。

/**
 * <b>Description:</b> 重新发起能力协商
 * <br><b>Purpose:</b>
 ...
 * @brief 发送会话外INFO消息
 * 
 * @param [in] CALL_S_SIP_INFO *info <b>:</b> sip info消息结构 
 * @retval TUP_API TUP_RESULT <b>:</b> 成功返回TUP_SUCCESS，失败返回相应错误码
 * 
 * @attention 产品在需要时使用此函数发送定制的sip info消息，以实现特定业务
 * @see NA
